package com.tsr.tsrproblemreport_tossticket_checker.sale_all_problem_from_cedit.line;

public class Config {

    //your admin panel url
    public static final String ADMIN_PANEL_URL = "http://www.arduinocodes.com/the_stream";
