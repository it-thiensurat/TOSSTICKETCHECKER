...
public class SectionListDataAdapter_image2 extends RecyclerView.Adapter<SectionListDataAdapter_image2.SingleItemRowHolder> {

    private ArrayList<SingleItemModel_checker2> itemsList;

    private Context mContext;
    SQLiteDatabase sqLiteDatabase;
    public SectionListDataAdapter_image2(Context context, ArrayList<SingleItemModel_checker2> itemsList) {
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, final int i) {
        ...
        final SingleItemModel_checker2 singleItem = itemsList.get(i);
