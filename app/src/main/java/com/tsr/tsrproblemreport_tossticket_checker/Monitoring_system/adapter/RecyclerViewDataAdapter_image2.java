...
public class RecyclerViewDataAdapter_image2 extends RecyclerView.Adapter<RecyclerViewDataAdapter_image2.ItemRowHolder> {

    private ArrayList<SectionDataModel_checker2> dataList;
    List<GetData_cedit_sale_edit_problem> getDataAdapter;
    private Context mContext;

    public RecyclerViewDataAdapter_image2(Context context, ArrayList<SectionDataModel_checker2> dataList) {
    ...
    public void onBindViewHolder(ItemRowHolder itemRowHolder, int i) {
        ...
        SectionListDataAdapter_image2 itemListDataAdapter = new SectionListDataAdapter_image2(mContext, singleSectionItems);
    ...
    private RecyclerViewDataAdapter_image2.itemclick_deleteAll_image2 ic_deleteAll;
    public void setitemclick_deleteAll3(RecyclerViewDataAdapter_image2.itemclick_deleteAll_image2 deleteAll){
        this.ic_deleteAll=deleteAll;
    }
    public interface itemclick_deleteAll_image2{


        void click_deleteAll_image2(View v, int position);
    }
            ...
            if(v==btnMore){
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll_image2(btnMore,getPosition());
                    }
                }
                ...
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll_image2(moreAll,getPosition());
                    }
                }
