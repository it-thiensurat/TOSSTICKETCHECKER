...
public class SectionListDataAdapter_image5 extends RecyclerView.Adapter<SectionListDataAdapter_image5.SingleItemRowHolder> {

    private ArrayList<SingleItemModel_checker5> itemsList;

    private Context mContext;
    SQLiteDatabase sqLiteDatabase;
    public SectionListDataAdapter_image5(Context context, ArrayList<SingleItemModel_checker5> itemsList) {
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, final int i) {
        ...
        final SingleItemModel_checker5 singleItem = itemsList.get(i);
