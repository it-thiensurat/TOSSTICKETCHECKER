 ...
 */
public class RecyclerViewAdapter_type_check_susscess2 extends RecyclerView.Adapter<RecyclerViewAdapter_type_check_susscess2.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapter_type_check_susscess2(List<Get_data_type_check> getDataAdapter, Context context){

        super();
        this.getDataAdapter = getDataAdapter;
        this.context = context;
        userFilter = new UserFilter(RecyclerViewAdapter_type_check_susscess2.this,getDataAdapter);
    }
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new RecyclerViewAdapter_type_check_susscess2.UserFilter(this,getDataAdapter);
        }
    ...
    private RecyclerViewAdapter_type_check_susscess2.itemclick_image_problem_incorrect22 ic_image_problem_incorrect;
    public void setitemclick_image_problem_incorrect(RecyclerViewAdapter_type_check_susscess2.itemclick_image_problem_incorrect22 image_problem_incorrect){
        this.ic_image_problem_incorrect=image_problem_incorrect;
    }
    public interface itemclick_image_problem_incorrect22{
        void click_image_problem_incorrect22(View v, int position);
    }




    private RecyclerViewAdapter_type_check_susscess2.itemclick_edit ic_edit;
    public void setitemclick_edit(RecyclerViewAdapter_type_check_susscess2.itemclick_edit edit){
        this.ic_edit=edit;
    }
            ...
            if (view == image_problem_incorrect) {
                try {
                    if (ic_image_problem_incorrect != null) {
                        ic_image_problem_incorrect.click_image_problem_incorrect22(image_problem_incorrect, getPosition());
                    }
                } catch (Exception e) {
    ...
    private static class UserFilter extends Filter {
        ...
        private final RecyclerViewAdapter_type_check_susscess2 adapter;

        private final List<Get_data_type_check> originalList;

        private final List<Get_data_type_check> filteredList;

        private UserFilter(RecyclerViewAdapter_type_check_susscess2 adapter, List<Get_data_type_check> originalList) {
            super();
