...
public class SectionListDataAdapter_image_map extends RecyclerView.Adapter<SectionListDataAdapter_image_map.SingleItemRowHolder> {

    private ArrayList<SingleItemModel_checker_map> itemsList;

    private Context mContext;
    SQLiteDatabase sqLiteDatabase;
    public SectionListDataAdapter_image_map(Context context, ArrayList<SingleItemModel_checker_map> itemsList) {
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, final int i) {
        ...
        final SingleItemModel_checker_map singleItem = itemsList.get(i);
