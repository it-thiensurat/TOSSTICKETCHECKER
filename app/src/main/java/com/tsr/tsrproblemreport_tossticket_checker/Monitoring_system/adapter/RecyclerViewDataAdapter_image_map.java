...
public class RecyclerViewDataAdapter_image_map extends RecyclerView.Adapter<RecyclerViewDataAdapter_image_map.ItemRowHolder> {

    private ArrayList<SectionDataModel_checker_map> dataList;
    List<GetData_cedit_sale_edit_problem> getDataAdapter;
    private Context mContext;

    public RecyclerViewDataAdapter_image_map(Context context, ArrayList<SectionDataModel_checker_map> dataList) {
    ...
    public void onBindViewHolder(ItemRowHolder itemRowHolder, int i) {
        ...
        SectionListDataAdapter_image_map itemListDataAdapter = new SectionListDataAdapter_image_map(mContext, singleSectionItems);
    ...
    private RecyclerViewDataAdapter_image_map.itemclick_deleteAll_image_map ic_deleteAll;
    public void setitemclick_deleteAll_map_map(RecyclerViewDataAdapter_image_map.itemclick_deleteAll_image_map deleteAll){
        this.ic_deleteAll=deleteAll;
    }
    public interface itemclick_deleteAll_image_map{


        void click_deleteAll_image_map(View v, int position);
    }
            ...
            if(v==btnMore){
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll_image_map(btnMore,getPosition());
                    }
                }
                ...
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll_image_map(moreAll,getPosition());
                    }
                }
