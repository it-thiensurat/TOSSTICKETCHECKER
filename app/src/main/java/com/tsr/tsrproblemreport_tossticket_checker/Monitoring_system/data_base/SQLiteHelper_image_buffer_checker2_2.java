...
public class SQLiteHelper_image_buffer_checker2_2 extends SQLiteOpenHelper {

    public static String DATABASE_NAME="checker2";
    ...
    public SQLiteHelper_image_buffer_checker2_2(Context context) {
