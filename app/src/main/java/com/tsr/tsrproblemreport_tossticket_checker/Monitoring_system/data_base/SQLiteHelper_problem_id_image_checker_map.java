...
public class SQLiteHelper_problem_id_image_checker_map extends SQLiteOpenHelper {

    public static String DATABASE_NAME="id_image_checker_map";

    public static final String TABLE_NAME="problem_id_image";
    ...
    public static final String Table_Main_problems="Main_problems";
    public static final String Table_Sub_problems="Sub_problems";
    ...
    public SQLiteHelper_problem_id_image_checker_map(Context context) {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        String CREATE_TABLE="CREATE TABLE IF NOT EXISTS "+TABLE_NAME+" ("+Table_Column_ID+" INTEGER PRIMARY KEY,  "+Table_part_id+" VARCHAR,"+Table_part_image+" VARCHAR,"+Table_Category+" VARCHAR,"+Table_Main_problems+" VARCHAR,"+Table_Sub_problems+" VARCHAR,"+Table_topic+" VARCHAR,"+Table_ProblemDetail+" VARCHAR,"+Table_datetime+" VARCHAR,"+Table_Url+" VARCHAR,"+Table_Image_Name+" VARCHAR,"+Table_Image_Size+" VARCHAR,"+Table_Image_Type+" VARCHAR,"+Table_order_image+" VARCHAR)";
