...
public class RecyclerViewDataAdapter_image5 extends RecyclerView.Adapter<RecyclerViewDataAdapter_image5.ItemRowHolder> {

    private ArrayList<SectionDataModel_checker5> dataList;
    List<GetData_cedit_sale_edit_problem> getDataAdapter;
    private Context mContext;

    public RecyclerViewDataAdapter_image5(Context context, ArrayList<SectionDataModel_checker5> dataList) {
    ...
    public void onBindViewHolder(ItemRowHolder itemRowHolder, int i) {
        ...
        SectionListDataAdapter_image5 itemListDataAdapter = new SectionListDataAdapter_image5(mContext, singleSectionItems);
    ...
    private RecyclerViewDataAdapter_image5.itemclick_deleteAll_image5 ic_deleteAll;
    public void setitemclick_deleteAll3(RecyclerViewDataAdapter_image5.itemclick_deleteAll_image5 deleteAll){
        this.ic_deleteAll=deleteAll;
    }
    public interface itemclick_deleteAll_image5{


        void click_deleteAll_image5(View v, int position);
    }
            ...
            if(v==btnMore){
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll_image5(btnMore,getPosition());
                    }
                }
                ...
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll_image5(moreAll,getPosition());
                    }
                }
