...
public class SQLiteHelper_image_buffer_checker4_2 extends SQLiteOpenHelper {

    public static String DATABASE_NAME="checker4";
    ...
    public SQLiteHelper_image_buffer_checker4_2(Context context) {
