...
public class RecyclerViewDataAdapter_image3 extends RecyclerView.Adapter<RecyclerViewDataAdapter_image3.ItemRowHolder> {

    private ArrayList<SectionDataModel_checker3> dataList;
    List<GetData_cedit_sale_edit_problem> getDataAdapter;
    private Context mContext;

    public RecyclerViewDataAdapter_image3(Context context, ArrayList<SectionDataModel_checker3> dataList) {
    ...
    public void onBindViewHolder(ItemRowHolder itemRowHolder, int i) {
        ...
        SectionListDataAdapter_image3 itemListDataAdapter = new SectionListDataAdapter_image3(mContext, singleSectionItems);
    ...
    private RecyclerViewDataAdapter_image3.itemclick_deleteAll_image3 ic_deleteAll;
    public void setitemclick_deleteAll3(RecyclerViewDataAdapter_image3.itemclick_deleteAll_image3 deleteAll){
        this.ic_deleteAll=deleteAll;
    }
    public interface itemclick_deleteAll_image3{


        void click_deleteAll_image3(View v, int position);
    }
            ...
            if(v==btnMore){
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll_image3(btnMore,getPosition());
                    }
                }
                ...
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll_image3(moreAll,getPosition());
                    }
                }
