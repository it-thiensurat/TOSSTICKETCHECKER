...
public class SectionListDataAdapter_image1 extends RecyclerView.Adapter<SectionListDataAdapter_image1.SingleItemRowHolder> {

    private ArrayList<SingleItemModel_checker1> itemsList;

    private Context mContext;
    SQLiteDatabase sqLiteDatabase;
    public SectionListDataAdapter_image1(Context context, ArrayList<SingleItemModel_checker1> itemsList) {
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, final int i) {
        ...
        final SingleItemModel_checker1 singleItem = itemsList.get(i);
