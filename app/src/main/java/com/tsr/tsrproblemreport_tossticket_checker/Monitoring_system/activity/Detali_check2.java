...
int status_report_problem_qr=0,status_report_problem_pay2=0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_for_1_2);
...
//        String ff3 =radioButton3.getText().toString();
        ...
        radioSexGroup.setOnCheckedChangeListener ( new RadioGroup.OnCheckedChangeListener ( )
                                                    {
                                                        ...
                                                        {
                                                            RadioButton checkedRadio = ( RadioButton ) Detali_check2.this.findViewById ( checkedId );
    ...
    */
        ...
        if((int) dayCount>45){
            ...
            // GET_JSON_DATA_HTTP_URL_data_check_over_day= "http://app.thiensurat.co.th/assanee/checker_system/problem/data_check_over_day_45.php";


            SQLiteDataBaseBuild_data_checker_problem_for_report();
            SQLiteTableBuild_data_checker_problem_for_report();
            String SQLiteDataBaseQueryHolder = "INSERT INTO " + SQLiteHelper_data_checker_problem_for_report.TABLE_NAME + " (CONTNO,GORY,MAIN,SUB,DETAILS,ProcessTypeID,ProblemID) VALUES('" + conno + "','" + "ปัญหาการ์ดตรวจสอบ" + "','" + "ลูกค้านัดเกินกำหนด" + "','" + "เกิน 45 วัน" + "','" + new_message_pay2.getText().toString() + "','" + "ตรวจสอบได้ เข้าบ้านลูกค้าไม่ได้" + "','" + "14" + "');";
            sqLiteDatabase.execSQL(SQLiteDataBaseQueryHolder);

        }

        else if((int) dayCount>60){
            txt_day_nad2.setText("เกิน 60 วัน");
            txt_day_nad2.setTextColor(0xffff0000);
            status_report_problem_pay2=1;
            // GET_JSON_DATA_HTTP_URL_data_check_over_day= "http://app.thiensurat.co.th/assanee/checker_system/problem/data_check_over_day_45.php";
            ...
            SQLiteDataBaseBuild_data_checker_problem_for_report();
            SQLiteTableBuild_data_checker_problem_for_report();
            String SQLiteDataBaseQueryHolder = "INSERT INTO " + SQLiteHelper_data_checker_problem_for_report.TABLE_NAME + " (CONTNO,GORY,MAIN,SUB,DETAILS,ProcessTypeID,ProblemID) VALUES('" + conno + "','" + "ปัญหาการ์ดตรวจสอบ" + "','" + "ลูกค้านัดเกินกำหนด" + "','" + "เกิน 60 วัน" + "','" + new_message_pay2.getText().toString() + "','" + "ตรวจสอบได้ เข้าบ้านลูกค้าไม่ได้" + "','" + "15" + "');";
            sqLiteDatabase.execSQL(SQLiteDataBaseQueryHolder);

        }
        else if((int) dayCount>75){
            txt_day_nad2.setText("เกิน 75 วัน");
            txt_day_nad2.setTextColor(0xffff0000);
            status_report_problem_pay2=1;
            // GET_JSON_DATA_HTTP_URL_data_check_over_day= "http://app.thiensurat.co.th/assanee/checker_system/problem/data_check_over_day_45.php";
            ...
            SQLiteDataBaseBuild_data_checker_problem_for_report();
            SQLiteTableBuild_data_checker_problem_for_report();
            String SQLiteDataBaseQueryHolder = "INSERT INTO " + SQLiteHelper_data_checker_problem_for_report.TABLE_NAME + " (CONTNO,GORY,MAIN,SUB,DETAILS,ProcessTypeID,ProblemID) VALUES('" + conno + "','" + "ปัญหาการ์ดตรวจสอบ" + "','" + "ลูกค้านัดเกินกำหนด" + "','" + "เกิน 75 วัน" + "','" + new_message_pay2.getText().toString() + "','" + "ตรวจสอบได้ เข้าบ้านลูกค้าไม่ได้" + "','" + "16" + "');";
            sqLiteDatabase.execSQL(SQLiteDataBaseQueryHolder);

        }
        else if((int) dayCount>90){
            txt_day_nad2.setText("เกิน 90 วัน");
            txt_day_nad2.setTextColor(0xffff0000);
            status_report_problem_pay2=1;
            // GET_JSON_DATA_HTTP_URL_data_check_over_day= "http://app.thiensurat.co.th/assanee/checker_system/problem/data_check_over_day_45.php";
            ...
            SQLiteDataBaseBuild_data_checker_problem_for_report();
            SQLiteTableBuild_data_checker_problem_for_report();
            String SQLiteDataBaseQueryHolder = "INSERT INTO " + SQLiteHelper_data_checker_problem_for_report.TABLE_NAME + " (CONTNO,GORY,MAIN,SUB,DETAILS,ProcessTypeID,ProblemID) VALUES('" + conno + "','" + "ปัญหาการ์ดตรวจสอบ" + "','" + "ลูกค้านัดเกินกำหนด" + "','" + "เกิน 90 วัน" + "','" + new_message_pay2.getText().toString() + "','" + "ตรวจสอบได้ เข้าบ้านลูกค้าไม่ได้" + "','" + "17" + "');";
            sqLiteDatabase.execSQL(SQLiteDataBaseQueryHolder);

        }
        else if((int) dayCount>120){
            txt_day_nad2.setText("เกิน 120 วัน");
            txt_day_nad2.setTextColor(0xffff0000);
            status_report_problem_pay2=1;
            // GET_JSON_DATA_HTTP_URL_data_check_over_day= "http://app.thiensurat.co.th/assanee/checker_system/problem/data_check_over_day_45.php";
            ...
            SQLiteDataBaseBuild_data_checker_problem_for_report();
            SQLiteTableBuild_data_checker_problem_for_report();
            String SQLiteDataBaseQueryHolder = "INSERT INTO " + SQLiteHelper_data_checker_problem_for_report.TABLE_NAME + " (CONTNO,GORY,MAIN,SUB,DETAILS,ProcessTypeID,ProblemID) VALUES('" + conno + "','" + "ปัญหาการ์ดตรวจสอบ" + "','" + "ลูกค้านัดเกินกำหนด" + "','" + "เกิน 120 วัน" + "','" + new_message_pay2.getText().toString() + "','" + "ตรวจสอบได้ เข้าบ้านลูกค้าไม่ได้" + "','" + "18" + "');";
            sqLiteDatabase.execSQL(SQLiteDataBaseQueryHolder);
 ...
 MyApplication.getInstance().getPrefManager().getPreferrence("part_image");
    ...
    public void onClick(View v) {
           if(v==bt_scan){
               Intent = new Intent(Detali_check2.this, MainActivity_barcode.class);

               startActivityForResult(Intent, 23);
           }
           else if(v==switcher2){
               if(error==0){
                   new SweetAlertDialog(Detali_check2.this, SweetAlertDialog.ERROR_TYPE)
                   ...
                   new SweetAlertDialog(Detali_check2.this, SweetAlertDialog.SUCCESS_TYPE)
                           .setTitleText("สแกนแล้ว!")
              ...
              final Dialog dialog = new Dialog(this);
               ...
               r_save_di.setOnClickListener(new View.OnClickListener() {
                   ...
                   public void onClick(View v) {
                       ...
                       File file = null;
                       ic = new ImageConfiguration(Detali_check2.this, PATH);
   ...
   /*            try {
                   Glide.with(Detali_check1.this).load(signaturePath)
                       ...
                       DatePickerDialog datePicker = new DatePickerDialog(Detali_check2.this, new DatePickerDialog.OnDateSetListener() {
                           @Override
            ...
            sweetAlertDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                ...
                public void onClick(SweetAlertDialog sDialog) {
                    ...
                    if(status_report_problem_qr==0&status_report_problem_pay2==1){
                        ...
                        SweetAlertDialog sweetAlertDialog = new SweetAlertDialog(Detali_check2.this, SweetAlertDialog.SUCCESS_TYPE);
                        ...
                        sweetAlertDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sDialog) {
                                ...
                                Intent = new Intent(Detali_check2.this, MusicActivity_Credit.class);
                                startActivity(Intent);
                                finish();
                        ...
                        sweetAlertDialog.setCancelClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sDialog) {
                                ...
                                Intent = new Intent(Detali_check2.this, MusicActivity_Checker.class);
                                startActivity(Intent);
                                finish();
                            }
                        });
