...
public class RecyclerViewDataAdapter_image4 extends RecyclerView.Adapter<RecyclerViewDataAdapter_image4.ItemRowHolder> {

    private ArrayList<SectionDataModel_checker4> dataList;
    List<GetData_cedit_sale_edit_problem> getDataAdapter;
    private Context mContext;

    public RecyclerViewDataAdapter_image4(Context context, ArrayList<SectionDataModel_checker4> dataList) {
    ...
    public void onBindViewHolder(ItemRowHolder itemRowHolder, int i) {
        ...
        SectionListDataAdapter_image4 itemListDataAdapter = new SectionListDataAdapter_image4(mContext, singleSectionItems);
    ...
    private RecyclerViewDataAdapter_image4.itemclick_deleteAll_image4 ic_deleteAll;
    public void setitemclick_deleteAll3(RecyclerViewDataAdapter_image4.itemclick_deleteAll_image4 deleteAll){
        this.ic_deleteAll=deleteAll;
    }
    public interface itemclick_deleteAll_image4{


        void click_deleteAll_image4(View v, int position);
    }
            ...
            if(v==btnMore){
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll_image4(btnMore,getPosition());
                    }
                }
                ...
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll_image4(moreAll,getPosition());
                    }
                }
