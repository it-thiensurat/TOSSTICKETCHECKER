...
public class SectionListDataAdapter_image4 extends RecyclerView.Adapter<SectionListDataAdapter_image4.SingleItemRowHolder> {

    private ArrayList<SingleItemModel_checker4> itemsList;

    private Context mContext;
    SQLiteDatabase sqLiteDatabase;
    public SectionListDataAdapter_image4(Context context, ArrayList<SingleItemModel_checker4> itemsList) {
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, final int i) {
        ...
        final SingleItemModel_checker4 singleItem = itemsList.get(i);
