...
public class SQLiteHelper_image_buffer_checker_pensing extends SQLiteOpenHelper {

    public static String DATABASE_NAME="pensing";
    ...
    public SQLiteHelper_image_buffer_checker_pensing(Context context) {
