...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.activities.DemoActivity;
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.fragments.UI_CARDVIEW_DATA_CEDIT_PC;
...
public class Detali_data_cedit2_fragment_pc extends Fragment implements OnMenuItemClickListener,OnMenuItemLongClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layoutView = inflater.inflate(R.layout.check_customer_new2, container, false);
      ...
      //  getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        try {
            ...
            fragment  = new UI_CARDVIEW_DATA_CEDIT_PC();
            getActivity().setTitle("รายการตรวจสอบ");
    ...
    private void initUI() {
        ...
        if (useMenuResource) {
            ...
            if(PositionCode.equals("Cedit")) {
                tabColors = getActivity().getApplicationContext().getResources().getIntArray(R.array.tab_colors);
                navigationAdapter = new AHBottomNavigationAdapter(getActivity(), R.menu.bottom_navigation_menu_3);
                ...
                tabColors = getActivity().getApplicationContext().getResources().getIntArray(R.array.tab_colors);
                navigationAdapter = new AHBottomNavigationAdapter(getActivity(), R.menu.bottom_navigation_menu_3_2);
                navigationAdapter.setupWithBottomNavigation(bottomNavigation, tabColors);
                bottomNavigation.setBackgroundResource(R.color.colorPrimary);
                //   bottomNavigation.getItem(R.id.check).setTitle("5555");
                AHBottomNavigationItem item3 = new AHBottomNavigationItem(R.string.tab_3, R.drawable.ic_maps_local_restaurant, R.color.color_tab_3);
...
*/
                ...
                AHNotification notification2 = new AHNotification.Builder()
                        .setText("100")
                        .setBackgroundColor(ContextCompat.getColor(getActivity(), R.color.color_notification_back))
                        .setTextColor(ContextCompat.getColor(getActivity(), R.color.color_notification_text))
                        .build();
...
/*
    ...
    public boolean onMenuItemClick(View clickedView, int position) {
        ...
        if(position==1){
            ...
            MyApplication.getInstance().getPrefManager().setPreferrence("latlong_pc", latitude+","+longitude);
            MyApplication.getInstance().getPrefManager().setPreferrence("dat2_pc", "1");
            MyApplication.getInstance().getPrefManager().setPreferrence("key_sort_pc", null);
            dad =1;
