package com.tsr.tsrproblemreport_tossticket_checker.mvp.base;
...
import com.tsr.tsrproblemreport_tossticket_checker.mvp.base.exception.MvpNotSetLayoutException;
import com.tsr.tsrproblemreport_tossticket_checker.mvp.base.exception.MvpPresenterNotCreateException;
...
public abstract class BaseMvpFragment<P extends BaseMvpInterface.Presenter>
    ...
    public abstract void setCustomerToAdapter(List<CustomerRes> customer);
    public abstract void setCustomerToAdapter_manager(List<ManagerRes> manager);
