package com.tsr.tsrproblemreport_tossticket_checker.mvp.Adapter;
...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.MyViewHolder> {
    ...
    private List<CustomerRes> list = new ArrayList<CustomerRes>();
    public ContactAdapter(Context context, List<CustomerRes> list){
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        CustomerRes res = list.get(position);
