package com.tsr.tsrproblemreport_tossticket_checker.payment_system;
...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.fragments.UI_CARDVIEW_DATA_CEDIT3;
...
public class MusicActivity_Payment extends AppCompatActivity implements OnMenuItemClickListener, OnMenuItemLongClickListener,GoogleApiClient.ConnectionCallbacks,
...
*/
        ...
        try {
            if(PositionCode.equals("Credit")){
                fragment  = new UI_CARDVIEW_DATA_CEDIT3();
                setTitle("รายการชำระเงินจากลูกค้า");
                            ...
                            try {
                                if(PositionCode.equals("Credit")){
                                   ...
                                   if(check.equals("check")){
                                       Intent showFullQuoteIntent = new Intent(MusicActivity_Payment.this, MusicActivity_Payment.class);
                        ...
                        if(CHECK_non_logout.equals("logout")) {
                            try {
                             ...
                             //   MyApplication.getInstance().getPrefManager().clear();
                                ...
                                Intent mIntent = new Intent( MusicActivity_Payment.this, LOGIN_MAIN.class);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                    ...
                    startActivity(new Intent(MusicActivity_Payment.this, MusicActivity_Checker.class));
                    finish();
              ...
              //      setTitle("ระบบตรวจสอบ");
                    ...
                    startActivity(new Intent(MusicActivity_Payment.this, MusicActivity_Credit.class));
                    finish();
                ...
                if (permissionsRejected.size() > 0) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            new AlertDialog.Builder(MusicActivity_Payment.this).
...
/*                super.onBackPressed();
    ...
    private void dialog_show_runing(){
        final Dialog dialog = new Dialog(MusicActivity_Payment.this);
...
Log.e("ssss","sssss");
            ...
            Toast.makeText(MusicActivity_Payment.this, "อัพเดทตำแหน่ง " +"เสร็จสิ้น", Toast.LENGTH_LONG).show();
        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(MusicActivity_Payment.this, obj.getString("success"), Toast.LENGTH_LONG).show();
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
