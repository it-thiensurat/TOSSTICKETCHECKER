package com.tsr.tsrproblemreport_tossticket_checker.test;
...
public class MainActivity_555 extends Fragment implements RecyclerViewDataAdapter.itemclick,RecyclerViewDataAdapter.itemclick2,RecyclerViewDataAdapter.itemclick_list_item_status_sale,RecyclerViewDataAdapter.itemclick_list_item_history  {
...
//            setSupportActionBar(toolbar);
    ...
    public void JSON_DATA_WEB_CALL() {
       ...
       // String user_code= MyApplication.getInstance().getPrefManager().getPreferrence("EMPID");
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+"A00098" ,
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL3(JSONArray array) {
        ...
        try {
            Glide.with(this).load(GetDataAdapter3.getPicture_sale())
                    .crossFade()
                    .thumbnail(0.5f)
                    .bitmapTransform(new com.tsr.tsrproblemreport_tossticket_checker.other_all.CircleTransform(getActivity()))
