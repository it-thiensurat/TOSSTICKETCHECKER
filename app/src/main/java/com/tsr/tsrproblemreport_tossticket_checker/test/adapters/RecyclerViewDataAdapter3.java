...
public class RecyclerViewDataAdapter3 extends RecyclerView.Adapter<RecyclerViewDataAdapter3.ItemRowHolder> implements Filterable {
    ...
    public RecyclerViewDataAdapter3(List<GetData_cedit_sale_edit_problem> getDataAdapter, Context context, ArrayList<SectionDataModel> dataList, ArrayList<SectionDataModel2> dataList2) {
        super();
        this.dataList = dataList;
        this.dataList2 = dataList2;
        this.context = context;
        this.getDataAdapter = getDataAdapter;
        userFilter = new UserFilter(RecyclerViewDataAdapter3.this,getDataAdapter);
    }


    @Override
    public ItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item22, null);
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new RecyclerViewDataAdapter3.UserFilter(this,getDataAdapter);
        }
        return userFilter;
    }
    ...
    public class ItemRowHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener,View.OnClickListener  {
        ...
        protected ImageView list_item_status_sale,image_status;
    ...
    private static class UserFilter extends Filter {
        ...
        private final RecyclerViewDataAdapter3 adapter;
        ...
        private UserFilter(RecyclerViewDataAdapter3 adapter, List<GetData_cedit_sale_edit_problem> originalList) {
            super();
