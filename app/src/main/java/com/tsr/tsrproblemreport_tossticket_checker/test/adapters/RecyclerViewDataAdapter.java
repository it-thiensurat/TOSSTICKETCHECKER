...
public class RecyclerViewDataAdapter extends RecyclerView.Adapter<RecyclerViewDataAdapter.ItemRowHolder> implements Filterable {
    ...
    public RecyclerViewDataAdapter(List<GetData_cedit_sale_edit_problem> getDataAdapter,Context context, ArrayList<SectionDataModel> dataList, ArrayList<SectionDataModel2> dataList2) {
        super();
        this.dataList = dataList;
        this.dataList2 = dataList2;
        this.context = context;
        this.getDataAdapter = getDataAdapter;
        userFilter = new UserFilter(RecyclerViewDataAdapter.this,getDataAdapter);
    }
...
/*        Viewholder.btnMore.setOnClickListener(new View.OnClickListener() {
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new RecyclerViewDataAdapter.UserFilter(this,getDataAdapter);
        }
        return userFilter;
    }
    ...
    public class ItemRowHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener,View.OnClickListener  {
        ...
        protected LinearLayout linear_head_image1,linear_head_image2,li_tel;
    ...
    private static class UserFilter extends Filter {
        ...
        private UserFilter(RecyclerViewDataAdapter adapter, List<GetData_cedit_sale_edit_problem> originalList) {
            super();
