...
public class Check_Fragment1_2_edit_tel extends Fragment implements RecyclerViewAdapter_type_check_susscess.itemclick2, View.OnClickListener,RecyclerViewAdapter_type_check_susscess.itemclick_image_problem_incorrect, RecyclerViewDataAdapter_dialog_image_problem_from_id_checker444.itemclick_deleteAll_id_checker4,RecyclerViewAdapter_type_check_susscess.itemclick_edit {
...
String PositionCode;
    ...
    LinearLayout li_ssd,LinearLayout_data1,LinearLayout_data12,data_old,data_new,liner3,li_line7,li_line8;
ImageView edit1,edit2,edit3,edit4,edit5,edit6,edit7,edit8,image_tal1,image_tal2,edit9,edit10,image_mylocation,image_mylocation_claer;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        li_ssd= (LinearLayout) view.findViewById(R.id.li_ssd);
...
/*            Intent Intent = new Intent(getActivity(), Activity_Call.class);
   ...
   /*         Intent Intent = new Intent(getActivity(), Activity_Call.class);
         ...
         /*   Intent Intent = new Intent(getActivity(), Activity_Call.class);
            ...
            LinearLayout_data1.setBackgroundColor(0xffffffff);
            ...
            LinearLayout_data1.setBackgroundColor(0xff8ecee5);
...
//        swipeRefreshLayout.setRefreshing(false);
    ...
    private  void INSENT_checker_edit_custommer_all(){
       ...
       try {
            Log.e("URL_Details_Images",API_URL_ALL.GET_JSON_INSENT_checker_edit_custommer_all_tel+"?Contno="+Contno+"&FnYear="+FnYear+"&FnMonth="+FnMonth+"&CustomerName="+URLEncoder.encode(CustomerName, "UTF-8")+"&IDCard="+IDCard+"&TelHome="+TelHome+"&TelMobile="+TelMobile+"&ipaddress="+ipaddress+"&computername="+URLEncoder.encode(computername, "UTF-8")+"&user_code="+InformEmpID+"&AddressDetail="+URLEncoder.encode(AddressDetail, "UTF-8")+"&Latitude="+latitude_ULOAD+"&Longitude="+longtitude_ULOAD);
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
...
//MyApplication.getInstance().getPrefManager().getPreferrence("InformID")
        ...
        try {
            jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_INSENT_checker_edit_custommer_all_tel+"?Contno="+Contno+"&FnYear="+FnYear+"&FnMonth="+FnMonth+"&CustomerName="+URLEncoder.encode(CustomerName, "UTF-8")+"&IDCard="+IDCard+"&TelHome="+TelHome+"&TelMobile="+TelMobile+"&ipaddress="+ipaddress+"&computername="+URLEncoder.encode(computername, "UTF-8")+"&user_code="+InformEmpID+"&AddressDetail="+URLEncoder.encode(AddressDetail, "UTF-8")+"&Latitude="+latitude_ULOAD+"&Longitude="+longtitude_ULOAD,
