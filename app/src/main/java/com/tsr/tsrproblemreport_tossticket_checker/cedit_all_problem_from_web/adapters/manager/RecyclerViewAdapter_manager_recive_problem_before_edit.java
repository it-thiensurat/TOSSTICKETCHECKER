...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.adapters.SectionListDataAdapter;
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.adapters.SectionListDataAdapter2;
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.databases.SQLiteHelper_position_image_all;
 ...
 */
public class RecyclerViewAdapter_manager_recive_problem_before_edit extends RecyclerView.Adapter<RecyclerViewAdapter_manager_recive_problem_before_edit.ViewHolder> implements Filterable {

    RecyclerViewDataAdapter3 adapter3;
    RecyclerViewDataAdapter4 adapter4;

    ArrayList<com.tsr.tsrproblemreport_tossticket_checker.test.models.SectionDataModel> allSampleData_test1;
    ArrayList<com.tsr.tsrproblemreport_tossticket_checker.test.models.SectionDataModel2> allSampleData_test2;
    ...
    ArrayList singleSectionItems2;
    SectionListDataAdapter itemListDataAdapter;
    SectionListDataAdapter2 itemListDataAdapter2;

    int i = 0;
  public static int position_image;
    ...
    public RecyclerViewAdapter_manager_recive_problem_before_edit(List<GetData_cedit_sale_edit_problem> getDataAdapter, Context context){
        super();
        this.getDataAdapter = getDataAdapter;
        this.context = context;
        userFilter = new UserFilter(RecyclerViewAdapter_manager_recive_problem_before_edit.this,getDataAdapter);
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      ...
      // View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.new_cardview, parent, false);
        View v= LayoutInflater.from(context).inflate(R.layout.list_item_home, parent, false);
...
Log.e("position_image", String.valueOf(position));
...
/*
        ...
        //adapter3 = new RecyclerViewDataAdapter3(context, allSampleData, imageBeforeList);
        itemListDataAdapter = new SectionListDataAdapter(context, imageBeforeList);
        my_recycler_view2.setAdapter(itemListDataAdapter);
       // itemListDataAdapter.notifyDataSetChanged();

        itemListDataAdapter2 = new SectionListDataAdapter2(context, imageAfterList);
        my_recycler_view.setAdapter(itemListDataAdapter2);
       // itemListDataAdapter2.notifyDataSetChanged();
*/
...
/*        adapter4 = new RecyclerViewDataAdapter4(context, allSampleData2, imageAfterList);
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new RecyclerViewAdapter_manager_recive_problem_before_edit.UserFilter(this,getDataAdapter);
        }
        return userFilter;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener,View.OnClickListener  {
        ...
        public TextView new_message,new_message2,new_message3,new_message4;
        ...
        public LinearLayout linear_status_closing,linear_sale3_main,linear_Informitem,linear_image,linear_sale3,linear_sale4;
        ...
        public ViewHolder(View itemView) {
            ...
            new_message3= (TextView) itemView.findViewById(id.new_message3) ;
            new_message4= (TextView) itemView.findViewById(id.new_message4) ;
            ...
            linear_sale3= (LinearLayout) itemView.findViewById(id.linear_sale3) ;
            linear_sale4= (LinearLayout) itemView.findViewById(id.linear_sale4) ;
           ...
           allSampleData = new ArrayList<SectionDataModel>();
            ...
            my_recycler_view2.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.HORIZONTAL, false));
    ...
    private static class UserFilter extends Filter {
        ...
        private final RecyclerViewAdapter_manager_recive_problem_before_edit adapter;
        ...
        private UserFilter(RecyclerViewAdapter_manager_recive_problem_before_edit adapter, List<GetData_cedit_sale_edit_problem> originalList) {
            super();
    ...
    public void SQLiteDataBaseBuild(){
        ...
        sqLiteDatabase = this.context.openOrCreateDatabase(SQLiteHelper_position_image_all.DATABASE_NAME, Context.MODE_PRIVATE, null);

    }

    public void SQLiteTableBuild(){

        sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS "+SQLiteHelper_position_image_all.TABLE_NAME+"("+ SQLiteHelper_position_image_all.Table_Column_ID+" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"+SQLiteHelper_position_image_all.Table_type_image+" VARCHAR,"+SQLiteHelper_position_image_all.Table_id_item+" VARCHAR, "+SQLiteHelper_position_image_all.Table_id_image+" VARCHAR, "+SQLiteHelper_position_image_all.Table_url+" VARCHAR);");
