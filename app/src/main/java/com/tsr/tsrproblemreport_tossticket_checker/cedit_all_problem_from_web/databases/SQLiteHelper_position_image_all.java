...
public class SQLiteHelper_position_image_all extends SQLiteOpenHelper {

    public static String DATABASE_NAME="IMAGE";
    public static final String TABLE_NAME="position_image";
    public static final String Table_Column_ID="id";

    public static final String Table_type_image="type_image";
    public static final String Table_id_item="id_item";
    public static final String Table_id_image="id_image";
    public static final String Table_url="url";



    public SQLiteHelper_position_image_all(Context context) {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        String CREATE_TABLE="CREATE TABLE IF NOT EXISTS "+TABLE_NAME+" ("+Table_Column_ID+" INTEGER PRIMARY KEY, "+Table_type_image+" VARCHAR, "+Table_id_item+" VARCHAR,  "+Table_id_image+" VARCHAR,  "+Table_url+" VARCHAR)";
