...
public class Detali_data_cedit3 extends AppCompatActivity  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(data!=null) {
            ...
            MyApplication.getInstance().getPrefManager().setPreferrence("NoID_cf", NoID);
