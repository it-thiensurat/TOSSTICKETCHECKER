...
public class ContactAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable, ItemTouchHelperAdapter {
...
Dialog dialog3;
   ...
   // String GET_JSON_DATA_HTTP_URL_insent_map = "http://app.thiensurat.co.th/assanee/api_cedit_all_problem_from_web/insertdismap.php";
    ...
    public ContactAdapter(RecyclerView recyclerView, List<GetData_cedit> contacts, FragmentActivity context, OnStartDragListener dragStartListener, OnCustomerListChangedListener onCustomerListChangedListener){
        super();
       ...
       // this.activity = activity;
        ...
        userFilter = new UserFilter(ContactAdapter.this,contacts);
...
public void Setloc(String a,String b){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof UserViewHolder) {
          ...
          //  position_adap = position;
            ...
            userViewHolder.txt_Fortnight_no.setText(contact.getFortnight_no());
            userViewHolder.txt_opendate.setText(contact.getOpendate());
            userViewHolder.txt_closedate.setText(contact.getClosedate());

            userViewHolder.txt_closedate2.setText(contact.getAssignDateTime());


            Log.e("getCheckerStatus",contact.getCheckerStatus()+"");
            try {
                if(contact.getCheckerStatus().equals("10")){
                    ...
                    userViewHolder.txt_status_closing.setText("รอดำเนินการ");
                    userViewHolder.txt_status_closing.setTextColor(0xffffffff);
            ...
            try {
                String NoID=contact.getNoID()+"";
                if(!NoID.equals("1")){
                    userViewHolder.handle2.setVisibility(View.VISIBLE);
                    userViewHolder.handle3.setVisibility(View.VISIBLE);
                }
                else {
                    userViewHolder.handle2.setVisibility(View.GONE);
                    userViewHolder.handle3.setVisibility(View.GONE);
                }
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new ContactAdapter.UserFilter(this,contacts);
        }
    ...
    private ContactAdapter.itemclick ic;
    public void setitemclick(ContactAdapter.itemclick ic){
        this.ic=ic;
    }
    ...
    private ContactAdapter.itemclick2 ic2;
    public void setitemclick2(ContactAdapter.itemclick2 ic2){
        this.ic2=ic2;
    }
    ...
    private class UserViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener,View.OnClickListener  {
        ...
        public LinearLayout linear_coler,linear_status_closing;
        public TextView  txt_status_closing;

        public TextView  txt_Fortnight_no;
        public TextView  txt_opendate;
        public TextView  txt_closedate,txt_closedate2;
        ...
        public UserViewHolder(View itemView) {
         ...
         //   Log.e("fffff","ffff");
            ...
            txt_Fortnight_no= (TextView) itemView.findViewById(R.id.txt_Fortnight_no);
            txt_opendate= (TextView) itemView.findViewById(R.id.txt_opendate);
            txt_closedate= (TextView) itemView.findViewById(R.id.txt_closedate);
            txt_closedate2= (TextView) itemView.findViewById(R.id.txt_closedate2);
    ...
    private static class UserFilter extends Filter {
        ...
        private UserFilter(ContactAdapter adapter, List<GetData_cedit> originalList) {
            super();
