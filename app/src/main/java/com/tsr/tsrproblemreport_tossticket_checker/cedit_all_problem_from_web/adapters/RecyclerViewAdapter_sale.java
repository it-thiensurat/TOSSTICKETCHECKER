 ...
 */
public class RecyclerViewAdapter_sale extends RecyclerView.Adapter<RecyclerViewAdapter_sale.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapter_sale(List<GetData_sale> getDataAdapter, Context context){

        super();
        this.getDataAdapter = getDataAdapter;
        this.context = context;
        userFilter = new UserFilter(RecyclerViewAdapter_sale.this,getDataAdapter);
    }
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new RecyclerViewAdapter_sale.UserFilter(this,getDataAdapter);
        }
    ...
    private static class UserFilter extends Filter {
        ...
        private final RecyclerViewAdapter_sale adapter;

        private final List<GetData_sale> originalList;

        private final List<GetData_sale> filteredList;

        private UserFilter(RecyclerViewAdapter_sale adapter, List<GetData_sale> originalList) {
            super();
