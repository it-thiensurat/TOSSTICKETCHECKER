...
public class Activity_check_problem_by_cedit extends AppCompatActivity implements View.OnClickListener{
    ...
    String ID="",Gory="",Main="",Sub="",Detail="",Detail2="",conno="",
            InformID_S="",Contno_S="",WorkCode_S="",WorkName_S="",Items_R="",new_message_main_S=""
            ,user_code="",
...
Log.e("dddd",GET_JSON_DATA_HTTP_URL + "?user_code=" + user_code+ "&ProblemID=" + ID+ "&Contno=" + Contno_S+ "&InformID=" + InformID_S);
    ...
    public void onClick(View view) {
        if(view==open_camera){
            ...
            Intent Intent = new Intent(Activity_check_problem_by_cedit.this, Show_dails_all.class);
