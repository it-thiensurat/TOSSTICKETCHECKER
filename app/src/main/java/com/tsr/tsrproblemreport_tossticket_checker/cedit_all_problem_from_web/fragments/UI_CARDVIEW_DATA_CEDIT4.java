...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.activities.Detali_data_cedit3_2_edit_tel;
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.activities.Detali_data_cedit3_4;
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.adapters.ContactAdapter4;
...
public class UI_CARDVIEW_DATA_CEDIT4 extends Fragment implements OnStartDragListener, OnCustomerListChangedListener, View.OnClickListener, ContactAdapter4.itemclick, ContactAdapter4.itemclick2,OnMapReadyCallback {


    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    @SuppressLint("ValidFragment")
    public UI_CARDVIEW_DATA_CEDIT4(Context mContext) {
    ...
    private ContactAdapter4 contactAdapter;
    ...
    String GET_JSON_DATA_HTTP_URL = BASE_URL+"assanee/checker_system/data_check2_new_tel.php";
    String GET_JSON_DATA_HTTP_URL_SE = BASE_URL+"assanee/checker_system/data_check2_new_SE_tel.php";
   ...
   public static int position2;
    ...
    Thread thread;
    public UI_CARDVIEW_DATA_CEDIT4() {
...
/*           if(dad==1){
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array) {
      ...
      //  SQLiteTableBuild_data_checker_all();
        ...
        contactAdapter = new ContactAdapter4(recyclerView, GetDataAdapter1, getActivity(), UI_CARDVIEW_DATA_CEDIT4.this, UI_CARDVIEW_DATA_CEDIT4.this);
...
/*                if (musicActivity_credit.dad == 1) {
                ...
                if (iis == ContactAdapter4.position_adap) {
    ...
    public void click2(View v, int position) {
        try {
            ...
            position2 = position;
                ...
                Intent Intent = new Intent(getActivity(), Detali_data_cedit3_2_edit_tel.class);
        ...
        if (view == fab) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                if (setlist == 0) {
                    ...
                    ContactAdapter4.color = 0xff999999;
                    ...
                    ContactAdapter4.color = 0xff000000;
