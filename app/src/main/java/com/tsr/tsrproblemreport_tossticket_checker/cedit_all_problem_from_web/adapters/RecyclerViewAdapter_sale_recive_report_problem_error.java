 ...
 */
public class RecyclerViewAdapter_sale_recive_report_problem_error extends RecyclerView.Adapter<RecyclerViewAdapter_sale_recive_report_problem_error.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapter_sale_recive_report_problem_error(List<GetData_cedit_sale_recive_problem> getDataAdapter, Context context){

        super();
        this.getDataAdapter = getDataAdapter;
        this.context = context;
        userFilter = new UserFilter(RecyclerViewAdapter_sale_recive_report_problem_error.this,getDataAdapter);
    }
    ...
    public void onBindViewHolder(ViewHolder Viewholder, int position) {
     ...
     //   Viewholder.txt_InformID.setText(getDataAdapter1.getInformID());
        ...
        try {
            String date=getDataAdapter1.getDate_modify();
            ...
            if(date_new_format_thai.indexOf(date_new_format_thai) != -1) {
                ...
                if((dateThai_day.equals(s1))&(dateThai_month.equals(s2))&(dateThai_year.equals(s3))){
                    Viewholder.tv_date.setText(date_new_format_thai2);
    ...
    private RecyclerViewAdapter_sale_recive_report_problem_error.itemclick_navigate ic_navigate;
    public void setitemclick_navigate(RecyclerViewAdapter_sale_recive_report_problem_error.itemclick_navigate navigate){
    ...
    private static class UserFilter extends Filter {
        ...
        private final RecyclerViewAdapter_sale_recive_report_problem_error adapter;
        ...
        private UserFilter(RecyclerViewAdapter_sale_recive_report_problem_error adapter, List<GetData_cedit_sale_recive_problem> originalList) {
            super();
