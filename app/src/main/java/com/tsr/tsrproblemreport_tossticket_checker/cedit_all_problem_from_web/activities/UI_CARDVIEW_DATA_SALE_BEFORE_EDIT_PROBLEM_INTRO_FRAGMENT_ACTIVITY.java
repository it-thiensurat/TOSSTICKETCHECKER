...
public class UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY extends AppCompatActivity implements RecyclerViewAdapter_manager_recive_problem_before_edit_acty.itemclick,RecyclerViewAdapter_manager_recive_problem_before_edit_acty.itemclick2,RecyclerViewAdapter_manager_recive_problem_before_edit_acty.itemclick_list_item_status_sale,RecyclerViewAdapter_manager_recive_problem_before_edit_acty.itemclick_txt_comment {
...
//UAT
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/sale_problem1_json2_real_from_cedit_edit_problem2_copy_real_history_number.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePicker = new DatePickerDialog(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
Log.e("InformID_acty",InformID);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                recyclerViewlayoutManager = new LinearLayoutManager(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY.this);
                ...
                pDialog2 = new SweetAlertDialog(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY.this, SweetAlertDialog.PROGRESS_TYPE);
                pDialog2.getProgressHelper().setBarColor(Color.parseColor("#A5DC86"));
                pDialog2.setTitleText("Loading");
                pDialog2.setCancelable(true);
                pDialog2.show();
    ...
    public void click(View v, int position) {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if(item==0){
                    Intent Intent = new Intent(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY.this, Show_dails_all.class);
                    Bundle bun = new Bundle();
                    bun.putString("contno", getData_cedit_sale_edit_problem.getContno());
                    Intent.putExtras(bun);
                    startActivityForResult(Intent, 55);
                    ...
                    String ResponStatus=getData_cedit_sale_edit_problem.getResponStatus();
                        ...
                        if(ResponStatus.equals("1")){
                            Intent Intent = new Intent(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY.this, Activity_edit_problem_from_sale.class);
                            Bundle bun = new Bundle();
                            bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                            bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                            bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
                            ...
                            Intent Intent = new Intent(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY.this, Activity_edit_problem_from_sale_edit_new.class);
                            Bundle bun = new Bundle();
                            bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                            bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                            bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
