...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.fragments.check_for_credit.Check_Fragment1_2_edit_tel;
import com.tsr.tsrproblemreport_tossticket_checker.other_all.MyApplication;

import java.util.ArrayList;

public class Detali_data_cedit3_2_edit_tel extends AppCompatActivity  {
    ...
    public static String CheckerStatus,from,ProductSerial,PayLastPeriod,Outstanding,FnYear,FnMonth,conno,productname,status,customer,idcard,address,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            fragment  = new Check_Fragment1_2_edit_tel();
    ...
    private void initUI() {
        ...
        bottomNavigation.setOnTabSelectedListener(new AHBottomNavigation.OnTabSelectedListener() {
            ...
            public boolean onTabSelected(int position, boolean wasSelected) {
                ...
                if (position == 0) {
                    fragment  = new Check_Fragment1_2();
                    setTitle("ข้อมูลลูกค้า");
