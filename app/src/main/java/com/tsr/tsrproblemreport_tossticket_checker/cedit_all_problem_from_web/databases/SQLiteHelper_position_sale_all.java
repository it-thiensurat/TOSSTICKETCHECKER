...
public class SQLiteHelper_position_sale_all extends SQLiteOpenHelper {

    public static String DATABASE_NAME="TV_ONLINE";
    public static final String TABLE_NAME="position_sale";
    ...
    public SQLiteHelper_position_sale_all(Context context) {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        String CREATE_TABLE="CREATE TABLE IF NOT EXISTS "+TABLE_NAME+" ("+Table_Column_ID+" INTEGER PRIMARY KEY,  "+Table_position+" VARCHAR)";
