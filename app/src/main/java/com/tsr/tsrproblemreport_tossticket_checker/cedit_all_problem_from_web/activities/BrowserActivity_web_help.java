...
public class BrowserActivity_web_help extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (Utils_web_help.isBookmarked(this, webView.getUrl())) {
            // change icon color
            Utils_web_help.tintMenuIcon(getApplicationContext(), menu.getItem(0), R.color.colorAccent);
        } else {
            Utils_web_help.tintMenuIcon(getApplicationContext(), menu.getItem(0), android.R.color.white);
        }
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_bookmark) {
            ...
            Utils_web_help.bookmarkUrl(this, webView.getUrl());

            String msg = Utils_web_help.isBookmarked(this, webView.getUrl()) ?
