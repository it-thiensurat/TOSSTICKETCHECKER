...
public class RecyclerViewDataAdapter_dialog_image_problem_from_id2 extends RecyclerView.Adapter<RecyclerViewDataAdapter_dialog_image_problem_from_id2.ItemRowHolder> {

    private List<GetData_cedit_dialog_image_problem_from_id> dataList;
    private Context mContext;

    public RecyclerViewDataAdapter_dialog_image_problem_from_id2(Context context, List<GetData_cedit_dialog_image_problem_from_id> dataList) {
...
//
    ...
    private RecyclerViewDataAdapter_dialog_image_problem_from_id2.itemclick_deleteAll2 ic_deleteAll;
    public void setitemclick_deleteAll2(RecyclerViewDataAdapter_dialog_image_problem_from_id2.itemclick_deleteAll2 deleteAll){
        this.ic_deleteAll=deleteAll;
    }
    public interface itemclick_deleteAll2{


        void click_deleteAll2(View v, int position);
    }
            ...
            if(v==image_remove){
                try {
                    if(ic_deleteAll!=null){
                        ic_deleteAll.click_deleteAll2(image_remove,getPosition());
                    }
                }
