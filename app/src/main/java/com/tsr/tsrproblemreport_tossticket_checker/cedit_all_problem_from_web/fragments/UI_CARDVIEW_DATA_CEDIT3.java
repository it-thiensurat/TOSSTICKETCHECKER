...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.activities.Detali_data_cedit3_3;
...
public class UI_CARDVIEW_DATA_CEDIT3 extends Fragment implements OnStartDragListener, OnCustomerListChangedListener, View.OnClickListener, ContactAdapter2.itemclick, ContactAdapter2.itemclick2,OnMapReadyCallback {


    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    @SuppressLint("ValidFragment")
    public UI_CARDVIEW_DATA_CEDIT3(Context mContext) {
    ...
    String GET_JSON_DATA_HTTP_URL = BASE_URL+"assanee/checker_system/data_check4.php";
   ...
   public static int position2;
    ...
    Thread thread;
    public UI_CARDVIEW_DATA_CEDIT3() {
     ...
     //   getDistanceInfo("13.950481,100.668204","13.898026,100.514533");
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePicker = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        date_s =  String.valueOf(year) + "-" + month_s;
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                JSON_DATA_WEB_CALL_DATE(date_s);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layoutView = inflater.inflate(R.layout.cardview_row_cedit8, container, false);
...
Log.e("currentDate",currentDate);
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL + "?CheckerEmpID=" + CheckerEmpID+ "&TransDate=" + currentDate,
    ...
    public void JSON_DATA_WEB_CALL_DATE(String DATE) {

        String CheckerEmpID = MyApplication.getInstance().getPrefManager().getPreferrence("EMPID");
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL + "?CheckerEmpID=" + CheckerEmpID+ "&TransDate=" + DATE,
      ...
      //  SQLiteTableBuild_data_checker_all();
        ...
        for (i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                GetDataAdapter2.setTrans_No(json.getString("Trans_No"));
                GetDataAdapter2.setBankName(json.getString("BankName"));
                GetDataAdapter2.setBankRef(json.getString("BankRef"));
                GetDataAdapter2.setBillerNo(json.getString("BillerNo"));
                GetDataAdapter2.setSerialNumber(json.getString("SerialNumber"));
                GetDataAdapter2.setRef2(json.getString("Ref2"));
                GetDataAdapter2.setQRId(json.getString("QRId"));
                GetDataAdapter2.setPayerName(json.getString("PayerName"));
                GetDataAdapter2.setPayerBank(json.getString("PayerBank"));
                GetDataAdapter2.setAmount(json.getString("Amount"));
                GetDataAdapter2.setResultCode(json.getString("ResultCode"));
                GetDataAdapter2.setResultDesc(json.getString("ResultDesc"));
               ...
               // GetDataAdapter2.setEFFDATE(json.getJSONObject("PayPeriod").getString("date"));
               GetDataAdapter2.setTransDate(json.getString("TransDate"));
                GetDataAdapter2.setPayPeriod(json.getString("PayPeriod"));
                GetDataAdapter2.setAllPeriods(json.getString("AllPeriods"));
...
//
        ...
        contactAdapter = new ContactAdapter2(recyclerView, GetDataAdapter1, getActivity(), UI_CARDVIEW_DATA_CEDIT3.this, UI_CARDVIEW_DATA_CEDIT3.this);
  ...
  /*      menuItem.setVisible(false);
    ...
    public void click2(View v, int position) {
        try {
            ...
            Intent Intent = new Intent(getActivity(), Detali_data_cedit3_3.class);


            Bundle bun = new Bundle();
            //    bun.putString("from","by_cedit");

            bun.putString("TransDate", getData_cedit.getTransDate());
            bun.putString("PayPeriod", getData_cedit.getPayPeriod());
            bun.putString("AllPeriods", getData_cedit.getAllPeriods());

            bun.putString("Trans_No", getData_cedit.getTrans_No());
            bun.putString("BankName", getData_cedit.getBankName());
            bun.putString("BankRef", getData_cedit.getBankRef());
            bun.putString("BillerNo", getData_cedit.getBillerNo());
            bun.putString("SerialNumber", getData_cedit.getSerialNumber());
            bun.putString("Ref2", getData_cedit.getRef2());
            bun.putString("QRId", getData_cedit.getQRId());
            bun.putString("PayerName", getData_cedit.getPayerName());
            bun.putString("PayerBank", getData_cedit.getPayerBank());
            bun.putString("Amount", getData_cedit.getAmount());
            bun.putString("ResultCode", getData_cedit.getResultCode());
            bun.putString("ResultDesc", getData_cedit.getResultDesc());
