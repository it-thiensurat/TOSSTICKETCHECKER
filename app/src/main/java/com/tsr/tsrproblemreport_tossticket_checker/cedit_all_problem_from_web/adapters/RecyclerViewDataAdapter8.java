...
public class RecyclerViewDataAdapter8 extends RecyclerView.Adapter<RecyclerViewDataAdapter8.ItemRowHolder> {

    private ArrayList<SectionDataModel2> dataList;
    ArrayList singleSectionItems2;
    SectionListDataAdapter8 itemListDataAdapter;
    private List<ImageAfter> imageAfterList;
    private Context mContext;
int i;
    public RecyclerViewDataAdapter8(Context context, ArrayList<SectionDataModel2> dataList, List<ImageAfter> imageAfterList2, int position) {
        this.dataList = dataList;
        this.mContext = context;
        this.imageAfterList=imageAfterList2;
        this.i=position;
        itemListDataAdapter = new SectionListDataAdapter8(mContext, singleSectionItems2,imageAfterList,i);
    }
    ...
    private RecyclerViewDataAdapter8.itemclick_deleteAll ic_deleteAll;
    public void setitemclick_deleteAll(RecyclerViewDataAdapter8.itemclick_deleteAll deleteAll){
