...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.adapters.RecyclerViewAdapter_sale_recive_report_problem_error;
...
public class UI_CARDVIEW_DATA_SALE_RECIVE_RPOBLEM extends Fragment implements RecyclerViewAdapter_sale_recive_report_problem_error.itemclick2,RecyclerViewAdapter_sale_recive_report_problem_error.itemclick_navigate  {

    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    @SuppressLint("ValidFragment")
    public UI_CARDVIEW_DATA_SALE_RECIVE_RPOBLEM(Context mContext) {
        this.mContext = mContext;
    }

    GetData_cedit_sale_recive_problem getData_cedit;
    List<GetData_cedit_sale_recive_problem> GetDataAdapter1;
    private RecyclerViewAdapter_sale_recive_report_problem_error contactAdapter;
   ...
   // String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/sale_problem1_json2_real_from_cedit_waiting_to_check2.php";
    ...
    Thread thread;
    public UI_CARDVIEW_DATA_SALE_RECIVE_RPOBLEM() {
    ...
    public void JSON_DATA_WEB_CALL2() {
        ...
        String WorkCode="22";
            ...
            jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL + "?user_code=" + user_code+"&WorkCode=" + WorkCode,
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                             ...
                             //   new SweetAlertDialog(getActivity(), SweetAlertDialog.ERROR_TYPE)
                                  //      .setTitleText("!Timeout Error/NoConnection Error")
                                //        .setContentText("กรุณาโหลดข้อมูลไหม่อีกครั้ง!")
                                     //   .show();
                                ...
                                new SweetAlertDialog(getActivity(), SweetAlertDialog.ERROR_TYPE)
                                        ...
                                        .setContentText("กรุณาแจ้งเจ้าหน้าที่!")
                                        .show();*/
        ...
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
               ...
               // GetDataAdapter2.setInformID(json.getString(JSON_InformID));
                ...
                GetDataAdapter2.setDate_modify(json.getJSONObject("date_create").getString("date"));
...
//                Log.e("latlong",latlong);
        ...
        contactAdapter = new RecyclerViewAdapter_sale_recive_report_problem_error(GetDataAdapter1, getActivity());
    ...
    public void click2(View v, int position) {
        ...
        Intent Intent = new Intent(getActivity(), UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM.class);
