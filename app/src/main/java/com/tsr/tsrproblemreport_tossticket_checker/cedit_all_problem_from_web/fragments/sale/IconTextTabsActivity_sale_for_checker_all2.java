...
public class IconTextTabsActivity_sale_for_checker_all2 extends Fragment {
   // public static  int check_cick_fragment=0;
    private int count = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.setAdapter(new CustomFragmentPageAdapterScollview_sale_for_checker_all2(getChildFragmentManager()));
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                tabIndex = tab.getPosition();
                 if(tabIndex==0){
                    ...
                    // tabLayout.getTabAt(3).setIcon(tabIcons[3]).setIcon(R.drawable.baseline_list_black_24);
                     //check_cick_fragment=0;
                   //  viewPager.setAdapter(new CustomFragmentPageAdapterScollview_sale_for_checker_all2(getChildFragmentManager()));
          ...
          /*      else if(tabIndex==3){
                     ...
                     tabLayout.getTabAt(1).setIcon(tabIcons[1]).setIcon(R.drawable.baseline_list_black_24);
                     tabLayout.getTabAt(2).setIcon(tabIcons[2]).setIcon(R.drawable.baseline_list_black_24);
                     tabLayout.getTabAt(3).setIcon(tabIcons[3]).setIcon(R.drawable.baseline_list_white_24);
                    // check_cick_fragment=3;
                   //  viewPager.setAdapter(new CustomFragmentPageAdapterScollview_sale_for_checker_all2(getChildFragmentManager()));

                 }*/

                Log.e("tabIndextabIndex", String.valueOf(tabIndex));
