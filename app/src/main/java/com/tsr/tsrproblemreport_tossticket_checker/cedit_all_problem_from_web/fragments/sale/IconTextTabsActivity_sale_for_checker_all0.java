...
public class IconTextTabsActivity_sale_for_checker_all0 extends Fragment {
    private int count = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.setAdapter(new CustomFragmentPageAdapterScollview_sale_for_checker_all0(getChildFragmentManager()));
