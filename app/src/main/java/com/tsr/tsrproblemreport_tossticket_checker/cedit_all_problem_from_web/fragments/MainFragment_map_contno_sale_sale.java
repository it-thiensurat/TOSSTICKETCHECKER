...
public class MainFragment_map_contno_sale_sale extends Fragment  implements OnMapReadyCallback,View.OnClickListener {


    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    @SuppressLint("ValidFragment")
    public MainFragment_map_contno_sale_sale(Context mContext) {
    ...
    String GET_JSON_DATA_HTTP_URL2 = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/sale_problem1_json2_real_from_cedit_waiting_to_check2_contno_map.php";
   public static GoogleMap googleMap;
    ...
    public MainFragment_map_contno_sale_sale() {
    ...
    public void JSON_DATA_WEB_CALL() {
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL + "?user_code=" + EMPID,
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array) {
        ...
        for (i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                GetDataAdapter2.setDate_modify(json.getJSONObject("date_modify").getString("date"));
    ...
    public void JSON_DATA_WEB_CALL2() {
        ...
        String EMPID = MyApplication.getInstance().getPrefManager().getPreferrence("EMPID");
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL2 + "?user_code=" + EMPID+ "&contno=" + CON,
