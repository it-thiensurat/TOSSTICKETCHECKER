...
public class ContactAdapter4 extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable, ItemTouchHelperAdapter {
...
Dialog dialog3;
   ...
   // String GET_JSON_DATA_HTTP_URL_insent_map = "http://app.thiensurat.co.th/assanee/api_cedit_all_problem_from_web/insertdismap.php";
    ...
    public ContactAdapter4(RecyclerView recyclerView, List<GetData_cedit> contacts, FragmentActivity context, OnStartDragListener dragStartListener, OnCustomerListChangedListener onCustomerListChangedListener){
        super();
       ...
       // this.activity = activity;
        ...
        userFilter = new UserFilter(ContactAdapter4.this,contacts);
...
public void Setloc(String a,String b){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.show_cardview_cedit5, parent, false);
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new ContactAdapter4.UserFilter(this,contacts);
        }
    ...
    private ContactAdapter4.itemclick ic;
    public void setitemclick(ContactAdapter4.itemclick ic){
        this.ic=ic;
    }
    ...
    private ContactAdapter4.itemclick2 ic2;
    public void setitemclick2(ContactAdapter4.itemclick2 ic2){
        this.ic2=ic2;
    }
    ...
    private class UserViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener,View.OnClickListener  {
        ...
        public TextView  txt_closedate;

        public TextView txt_status;
        //     public TextView lbl_name;
        //  public TextView title;
        public LinearLayout linear_coler,linear_status_closing,li_p;
        ...
        public UserViewHolder(View itemView) {
         ...
         //   Log.e("fffff","ffff");
            ...
            li_p= (LinearLayout) itemView.findViewById(R.id.li_p);
            ...
            linear_coler.setVisibility(View.GONE);
    ...
    private static class UserFilter extends Filter {
        ...
        private final ContactAdapter4 adapter;

        private final List<GetData_cedit> originalList;

        private final List<GetData_cedit> filteredList;

        private UserFilter(ContactAdapter4 adapter, List<GetData_cedit> originalList) {
            super();
