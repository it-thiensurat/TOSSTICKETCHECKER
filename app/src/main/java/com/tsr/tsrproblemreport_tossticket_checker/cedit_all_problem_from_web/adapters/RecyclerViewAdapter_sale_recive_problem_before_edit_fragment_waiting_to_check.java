 ...
 */
public class RecyclerViewAdapter_sale_recive_problem_before_edit_fragment_waiting_to_check extends RecyclerView.Adapter<RecyclerViewAdapter_sale_recive_problem_before_edit_fragment_waiting_to_check.ViewHolder> implements Filterable {
   ...
   String GET_JSON_DATA_HTTP_URL="http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/select_image_problem_from_id_copy_real.php";
    ...
    public RecyclerViewAdapter_sale_recive_problem_before_edit_fragment_waiting_to_check(List<GetData_cedit_sale_edit_problem> getDataAdapter, Context context){

        super();
        this.getDataAdapter = getDataAdapter;
        this.context = context;
        userFilter = new UserFilter(RecyclerViewAdapter_sale_recive_problem_before_edit_fragment_waiting_to_check.this,getDataAdapter);
    }
...
/*
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new RecyclerViewAdapter_sale_recive_problem_before_edit_fragment_waiting_to_check.UserFilter(this,getDataAdapter);
        }
    ...
    private static class UserFilter extends Filter {
        ...
        private final RecyclerViewAdapter_sale_recive_problem_before_edit_fragment_waiting_to_check adapter;
        ...
        private UserFilter(RecyclerViewAdapter_sale_recive_problem_before_edit_fragment_waiting_to_check adapter, List<GetData_cedit_sale_edit_problem> originalList) {
            super();
