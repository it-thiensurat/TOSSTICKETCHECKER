...
public class UI_CARDVIEW_DATA_CEDIT2_2 extends Fragment implements OnStartDragListener, OnCustomerListChangedListener, View.OnClickListener, ContactAdapter2.itemclick, ContactAdapter2.itemclick2,OnMapReadyCallback {


    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    @SuppressLint("ValidFragment")
    public UI_CARDVIEW_DATA_CEDIT2_2(Context mContext) {
    ...
    String GET_JSON_DATA_HTTP_URL = BASE_URL+"assanee/checker_system/data_check2_new2.php";
    String GET_JSON_DATA_HTTP_URL_SE = BASE_URL+"assanee/checker_system/data_check2_new_SE2.php";
   ...
   public static int position2;
    ...
    Thread thread;
    public UI_CARDVIEW_DATA_CEDIT2_2() {
...
/*           if(dad==1){
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array) {
      ...
      //  SQLiteTableBuild_data_checker_all();
        ...
        contactAdapter = new ContactAdapter2(recyclerView, GetDataAdapter1, getActivity(), UI_CARDVIEW_DATA_CEDIT2_2.this, UI_CARDVIEW_DATA_CEDIT2_2.this);
