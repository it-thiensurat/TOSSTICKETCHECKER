...
public class MainFragment_map_contno_sale extends Fragment  implements OnMapReadyCallback,View.OnClickListener {


    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    public MainFragment_map_contno_sale(Context mContext) {
    ...
    public MainFragment_map_contno_sale() {
    ...
    public void JSON_DATA_WEB_CALL() {
        ...
        Log.e("likee",GET_JSON_DATA_HTTP_URL + "?SaleEmployeeName=" + EmployeeName);
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL + "?SaleEmployeeName=" + EmployeeName,
