...
public class IconTextTabsActivity_credit_checker_PC extends Fragment {
    private int count = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.setAdapter(new CustomFragmentPageAdapterScollview_credit_checker_PC(getChildFragmentManager()));
