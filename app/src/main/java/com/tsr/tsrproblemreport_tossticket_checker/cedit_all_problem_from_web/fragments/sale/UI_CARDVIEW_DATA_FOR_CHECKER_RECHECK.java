...
import static com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.MusicActivity_Credit.dad_mac;

public class UI_CARDVIEW_DATA_FOR_CHECKER_RECHECK extends Fragment implements OnStartDragListener, OnCustomerListChangedListener, View.OnClickListener, ContactAdapter_sale.itemclick, ContactAdapter_sale.itemclick2,OnMapReadyCallback {


    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    @SuppressLint("ValidFragment")
    public UI_CARDVIEW_DATA_FOR_CHECKER_RECHECK(Context mContext) {
   ...
   // String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/checker_system/sale/data_check_sale2.php";
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/checker_system/sale/data_check_sale2_2.php";
    String GET_JSON_DATA_HTTP_URL_number_page = "http://app.thiensurat.co.th/assanee/checker_system/sale/data_check_sale2_2_number_page.php";
   ...
   public static int position2;
    ...
    public UI_CARDVIEW_DATA_FOR_CHECKER_RECHECK() {
