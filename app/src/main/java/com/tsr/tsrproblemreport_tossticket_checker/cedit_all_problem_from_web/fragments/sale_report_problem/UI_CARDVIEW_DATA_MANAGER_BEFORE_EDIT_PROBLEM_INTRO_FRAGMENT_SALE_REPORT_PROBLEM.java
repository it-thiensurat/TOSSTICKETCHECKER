package com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.fragments.sale_report_problem;
...
public class UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_SALE_REPORT_PROBLEM extends Fragment implements RecyclerViewDataAdapter3.itemclick,RecyclerViewDataAdapter3.itemclick2,RecyclerViewDataAdapter3.itemclick_list_item_status_sale,RecyclerViewDataAdapter3.itemclick_list_item_history,RecyclerViewDataAdapter3.itemclick_relat_remove  {
...
//                recyclerViewDataAdapter.notifyItemRemoved(scrollPosition);
    ...
    public void JSON_DATA_WEB_CALL() {
      ...
      //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
                jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_SALE_REPORT_PROBLEM+"?user_code="+user_code +"&page="+number_page ,
    ...
    public void JSON_DATA_WEB_CALL_SE(String data) {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_SE_PAGE_SALE_REPORT_PROBLEM+"?user_code="+user_code +"&data="+data ,
...
Log.e("errorrrrrrrrr",e.getLocalizedMessage()+"");
    ...
    public void JSON_DATA_WEB_CALL_date_to_date() {
        ...
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_date1_to_date2_SALE_REPORT_PROBLEM+"?user_code="+user_code+"&date1="+date_s+"&date2="+date2_s+"&page="+number_page ,
    ...
    public void JSON_DATA_WEB_CALL_number_page() {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_number_page_SALE_REPORT_PROBLEM+"?user_code="+user_code  ,
    ...
    public void JSON_DATA_WEB_CALL_number_page_date1_to_date2() {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_number_page_date1_to_date2_SALE_REPORT_PROBLEM+"?user_code="+user_code+"&date1="+date_s+"&date2="+date2_s ,
