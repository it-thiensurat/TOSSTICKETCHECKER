...
public class Check_Fragment1_3 extends Fragment implements RecyclerViewAdapter_type_check_susscess.itemclick2, View.OnClickListener,RecyclerViewAdapter_type_check_susscess.itemclick_image_problem_incorrect, RecyclerViewDataAdapter_dialog_image_problem_from_id_checker444.itemclick_deleteAll_id_checker4,RecyclerViewAdapter_type_check_susscess.itemclick_edit {
...
String PositionCode;
    ...
    TextView BankName_txt,BankRef_txt,BillerNo_txt,SerialNumber_txt,
            Ref2_txt,QRId_txt,PayerName_txt,PayerBank_txt,Amount_txt,
            ResultCode_txt,ResultDesc_txt,TransDate,AllPeriods;

    public static String Trans_No,BankName,BankRef,BillerNo,SerialNumber,Ref2,QRId,PayerName,PayerBank,Amount,ResultCode,ResultDesc;
...
ImageView edit1,edit2,edit3,edit4,edit5,edit6,edit7,edit8,image_tal1,image_tal2,edit9,edit10,image_mylocation,image_mylocation_claer;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_check_for_credit3, container, false);
       ...
       // Trans_No_txt= (TextView) view.findViewById(R.id.Trans_No);
        BankName_txt= (TextView) view.findViewById(R.id.BankName);
        BankRef_txt= (TextView) view.findViewById(R.id.BankRef);
        BillerNo_txt = (TextView) view.findViewById(R.id.BillerNo);
        SerialNumber_txt= (TextView) view.findViewById(R.id.SerialNumber);
        Ref2_txt= (TextView) view.findViewById(R.id.Ref2);
        QRId_txt= (TextView) view.findViewById(R.id.QRId);
        PayerName_txt= (TextView) view.findViewById(R.id.PayerName);
        PayerBank_txt= (TextView) view.findViewById(R.id.PayerBank);
        Amount_txt= (TextView) view.findViewById(R.id.Amount);
        ResultCode_txt= (TextView) view.findViewById(R.id.ResultCode);
        ResultDesc_txt= (TextView) view.findViewById(R.id.ResultDesc);



        AllPeriods= (TextView) view.findViewById(R.id.AllPeriods);
      ...
      //  viewPager = (ViewPager)view.findViewById(R.id.viewPager);
       ...
       // ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getActivity());
        ...
        Trans_No=MyApplication.getInstance().getPrefManager().getPreferrence("Trans_No_cf")+"";
        BankName=MyApplication.getInstance().getPrefManager().getPreferrence("BankName_cf")+"";
        BankRef=MyApplication.getInstance().getPrefManager().getPreferrence("BankRef_cf")+"";
        BillerNo=MyApplication.getInstance().getPrefManager().getPreferrence("BillerNo_cf")+"";
        SerialNumber=MyApplication.getInstance().getPrefManager().getPreferrence("SerialNumber_cf")+"";
        Ref2=MyApplication.getInstance().getPrefManager().getPreferrence("Ref2_cf")+"";
        QRId=MyApplication.getInstance().getPrefManager().getPreferrence("QRId_cf")+"";
        PayerName=MyApplication.getInstance().getPrefManager().getPreferrence("PayerName_cf")+"";
        PayerBank=MyApplication.getInstance().getPrefManager().getPreferrence("PayerBank_cf")+"";
        Amount=MyApplication.getInstance().getPrefManager().getPreferrence("Amount_cf")+"";
        ResultCode=MyApplication.getInstance().getPrefManager().getPreferrence("ResultCode_cf")+"";
        ResultDesc=MyApplication.getInstance().getPrefManager().getPreferrence("ResultDesc_cf")+"";
        ...
        txt_productname.setText(productname);
                 ...
                 BankName_txt.setText(BankName);
                 BankRef_txt.setText(BankRef);
                 BillerNo_txt.setText(BillerNo);
                 SerialNumber_txt.setText(SerialNumber);
                 Ref2_txt.setText(Ref2);
                 QRId_txt.setText(QRId);
                 PayerName_txt.setText(PayerName);
                 PayerBank_txt.setText(PayerBank);
                 Amount_txt.setText(Amount+"/"+MyApplication.getInstance().getPrefManager().getPreferrence("PayPeriod_cf")+" บาท");

                 int r1= Integer.parseInt(Amount);
                 int r2= Integer.parseInt(MyApplication.getInstance().getPrefManager().getPreferrence("PayPeriod_cf"));
                 if(r1<r2){
                     Amount_txt.setTextColor(0xfff40707);
                 }
                 else {
                     Amount_txt.setTextColor(0xff988a62);
                 }

                 ResultCode_txt.setText(ResultCode);
                 ResultDesc_txt.setText(ResultDesc);
        AllPeriods.setText(MyApplication.getInstance().getPrefManager().getPreferrence("AllPeriods_cf"));
        TransDate.setText(MyApplication.getInstance().getPrefManager().getPreferrence("TransDate_cf"));
