...
public class MusicActivity_Credit extends AppCompatActivity implements OnMenuItemClickListener, OnMenuItemLongClickListener {
                      ...
                      //      startService(new Intent(MusicActivity_Credit.this, FloatWidgetService.class));
                            ...
                            try {
                                if(PositionCode.equals("Credit")){
                                   ...
                                   if(check.equals("check")){
                                       Intent showFullQuoteIntent = new Intent(MusicActivity_Credit.this, MusicActivity_Credit.class);
                                       startActivity(showFullQuoteIntent);
                                       finish();
                                   }
                        ...
                        if(CHECK_non_logout.equals("logout")) {
                            try {
                                ...
                                Intent mIntent = new Intent( MusicActivity_Credit.this, INTRO_APP.class);
    ...
    navigationView.setBackgroundColor(dd);
        ...
        try {
            if(PositionCode.equals("Credit")){
                ...
                navigationView.getMenu().findItem(R.id.nav_report_problem).setVisible(true);      // แจ้งปัญหาของเชล
                navigationView.getMenu().findItem(R.id.nav_report_contno).setVisible(true);       // แจ้งปัญหาของเชล
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                 ...
                 //   setTitle("รายการที่ตรวจสอบแล้ว");
                  ...
                  //  startActivity(new Intent(MusicActivity_Credit.this, MainActivity_555.class));
                   // return true;
                    ...
                    startActivity(new Intent(MusicActivity_Credit.this, MusicActivity_Checker.class));
                    finish();
                     return true;
              //      setTitle("ระบบตรวจสอบ");
                   ...
                   startActivity(new Intent(MusicActivity_Credit.this, MusicActivity_Payment.class));
                    finish();
                    return true;
                    //      setTitle("ระบบตรวจสอบ");
                }
...
/*               new AppUpdater(context)
        ...
        try {
            ...
            insert_gps_gis= new INSERT_GPS_GIS(this);
            insert_gps_gis.gg();
...
/*                super.onBackPressed();
    ...
    private void dialog_show_runing(){
        final Dialog dialog = new Dialog(MusicActivity_Credit.this);
...
Log.e("ssss","sssss");
            ...
            Toast.makeText(MusicActivity_Credit.this, "อัพเดทตำแหน่ง " +"เสร็จสิ้น", Toast.LENGTH_LONG).show();
        }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(MusicActivity_Credit.this, obj.getString("success"), Toast.LENGTH_LONG).show();
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
...
String row_all1_add="",page_add="";
   ...
   public void openAppSettings() {
    ...
    public   void insert_gis(){   // have cs

        String latitude="33.00";
        String longitude="66.00";
        ...
        Log.e("deviceIddeviceId",deviceId+","+empId);

        StringRequest postRequest = new StringRequest(Request.Method.POST, "http://toss.thiensurat.co.th/ServicesPHP/Production/GIS/TrackingLocation",
                new Response.Listener<String>()
                {
                    @Override
                    public void onResponse(String response) {
