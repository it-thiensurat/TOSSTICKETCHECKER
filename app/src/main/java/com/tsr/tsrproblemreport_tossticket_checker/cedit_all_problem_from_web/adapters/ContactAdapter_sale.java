...
public class ContactAdapter_sale extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable, ItemTouchHelperAdapter {
...
Dialog dialog3;
   ...
   // String GET_JSON_DATA_HTTP_URL_insent_map = "http://app.thiensurat.co.th/assanee/api_cedit_all_problem_from_web/insertdismap.php";
    ...
    public ContactAdapter_sale(RecyclerView recyclerView, List<GetData_cedit> contacts, FragmentActivity context, OnStartDragListener dragStartListener, OnCustomerListChangedListener onCustomerListChangedListener){
        super();
       ...
       // this.activity = activity;
        ...
        userFilter = new UserFilter(ContactAdapter_sale.this,contacts);
...
public void Setloc(String a,String b){
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new ContactAdapter_sale.UserFilter(this,contacts);
        }
    ...
    private ContactAdapter_sale.itemclick ic;
    public void setitemclick(ContactAdapter_sale.itemclick ic){
        this.ic=ic;
    }
    ...
    private ContactAdapter_sale.itemclick2 ic2;
    public void setitemclick2(ContactAdapter_sale.itemclick2 ic2){
        this.ic2=ic2;
    }
    ...
    private static class UserFilter extends Filter {
        ...
        private final ContactAdapter_sale adapter;

        private final List<GetData_cedit> originalList;

        private final List<GetData_cedit> filteredList;

        private UserFilter(ContactAdapter_sale adapter, List<GetData_cedit> originalList) {
            super();
