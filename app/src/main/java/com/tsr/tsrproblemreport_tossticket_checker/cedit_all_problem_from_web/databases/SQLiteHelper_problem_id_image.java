...
public class SQLiteHelper_problem_id_image extends SQLiteOpenHelper {

    public static String DATABASE_NAME="TV_ONLINE";
    ...
    public SQLiteHelper_problem_id_image(Context context) {
