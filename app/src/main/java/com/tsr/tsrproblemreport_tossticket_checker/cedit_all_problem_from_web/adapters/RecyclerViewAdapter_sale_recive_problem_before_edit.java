 ...
 */
public class RecyclerViewAdapter_sale_recive_problem_before_edit extends RecyclerView.Adapter<RecyclerViewAdapter_sale_recive_problem_before_edit.ViewHolder> implements Filterable {
   ...
   String GET_JSON_DATA_HTTP_URL="http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/select_image_problem_from_id_copy_real.php";
    ...
    public RecyclerViewAdapter_sale_recive_problem_before_edit(List<GetData_cedit_sale_edit_problem> getDataAdapter, Context context){

        super();
        this.getDataAdapter = getDataAdapter;
       // this.details_contnos=details_contnos;
        this.context = context;
        userFilter = new UserFilter(RecyclerViewAdapter_sale_recive_problem_before_edit.this,getDataAdapter);
    }
...
/*
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new RecyclerViewAdapter_sale_recive_problem_before_edit.UserFilter(this,getDataAdapter);
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener,View.OnClickListener  {
      ...
      //  public  static ImageView image_status;
        ...
        public ViewHolder(View itemView) {
            ...
            /*
            Intent Intent = new Intent(context, Activity_edit_problem_from_sale.class);
            Bundle bun = new Bundle();
            bun.putString("ID", feed.getID());
            final String WorkCode=feed.getWorkCode();
           itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(!WorkCode.equals("22")){
                        ...
                        Bundle bun = new Bundle();
                        bun.putString("ID", feed.getID());
                        bun.putString("Gory", feed.getGory());
                        bun.putString("Main", feed.getMain());
                        bun.putString("Sub", feed.getTopic_problem());
                        bun.putString("Detail", feed.getProblemDetail());
                        bun.putString("conno", feed.getContno());
                        bun.putString("InformID", feed.getInformID());
                        bun.putString("Contno", feed.getContno());
                        bun.putString("WorkCode", feed.getWorkCode());
                        bun.putString("WorkName", feed.getWorkName());
                        bun.putString("date_time", feed.getDate_create());
    ...
    private static class UserFilter extends Filter {
        ...
        private final RecyclerViewAdapter_sale_recive_problem_before_edit adapter;
        ...
        private UserFilter(RecyclerViewAdapter_sale_recive_problem_before_edit adapter, List<GetData_cedit_sale_edit_problem> originalList) {
            super();
