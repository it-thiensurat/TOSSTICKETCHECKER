...
//    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/sale_problem1_json2_real_from_cedit_edit_problem2.php";
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/cedit_problem1_json2_real_from_cedit_edit_problem2_copy_waiting_to_check_real_sale.php";
    String GET_JSON_DATA_HTTP_URL_date1_to_date2 = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/cedit_problem1_json2_real_from_cedit_edit_problem2_copy_waiting_to_check_real_date1_to_date2_sale.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePicker = new DatePickerDialog(UI_CARDVIEW_DATA_CREDIT_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT2_Acti_sale.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pDialog2 = new SweetAlertDialog(UI_CARDVIEW_DATA_CREDIT_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT2_Acti_sale.this, SweetAlertDialog.PROGRESS_TYPE);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                recyclerViewlayoutManager = new LinearLayoutManager(UI_CARDVIEW_DATA_CREDIT_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT2_Acti_sale.this);
    ...
    public void JSON_DATA_WEB_CALL() {
        ...
        String user_code= MyApplication.getInstance().getPrefManager().getPreferrence("SALECODE");
   ...
   public static boolean open_up_down=false;
    ...
    public void click_list_item_status_sale(View v, int position) {
        ...
        Log.e("conno_aa",conno_aa);
         ...
         pDialog = new SweetAlertDialog(UI_CARDVIEW_DATA_CREDIT_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT2_Acti_sale.this, SweetAlertDialog.PROGRESS_TYPE);
    ...
    public void click(View v, int position) {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if(item==0){
                    Intent Intent = new Intent(UI_CARDVIEW_DATA_CREDIT_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT2_Acti_sale.this, Show_dails_all.class);
                    Bundle bun = new Bundle();
                    bun.putString("contno", getData_cedit_sale_edit_problem.getContno());
                    Intent.putExtras(bun);
                    startActivityForResult(Intent, 55);
