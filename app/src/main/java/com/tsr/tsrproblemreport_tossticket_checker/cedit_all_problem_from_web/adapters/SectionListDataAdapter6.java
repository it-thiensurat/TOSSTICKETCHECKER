...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.databases.SQLiteHelper_position_delate_image;
...
public class SectionListDataAdapter6 extends RecyclerView.Adapter<SectionListDataAdapter6.SingleItemRowHolder> {
    ...
    public SectionListDataAdapter6(Context context, ArrayList<SingleItemModel2> itemsList) {
...
/*    public void setLongclick(longclick longclick){
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, final int i) {
      ...
      //  holder.tvTitle.setText(singleItem.getName());
        ...
        holder.fff.setOnLongClickListener(new View.OnLongClickListener()  {
            @Override
            public boolean onLongClick(View v) {
                if(!check){
                    Log.e("dddd",singleItem.getName()+"กด");
                    check=true;
                }
                else {
                  //  check=true;
                    Log.e("rrrr",singleItem.getName()+"ออก");
                }
                return false;
            }
    ...
    public class SingleItemRowHolder extends RecyclerView.ViewHolder {
        ...
        public SingleItemRowHolder(View view) {
           ...
           // checkBox= (CheckBox) itemView.findViewById(R.id.checkBox) ;
            this.fff = (LinearLayout) view.findViewById(R.id.fff);

       /*     itemImage.setOnLongClickListener(new View.OnLongClickListener() {
                @Override
                    public boolean onLongClick(View v) {
                    if(longclick!=null){
                        longclick.longclick(v,getPosition());
                    }
                    return false;
                }
            });*/
    ...
    public void SQLiteDataBaseBuild(){
        ...
        sqLiteDatabase = mContext.openOrCreateDatabase(SQLiteHelper_position_delate_image.DATABASE_NAME, Context.MODE_PRIVATE, null);
    ...
    public void SQLiteTableBuild(){
        ...
        sqLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS "+SQLiteHelper_position_delate_image.TABLE_NAME+"("+ SQLiteHelper_position_delate_image.Table_Column_ID+" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"+SQLiteHelper_position_delate_image.Table_position+" VARCHAR, "+SQLiteHelper_position_delate_image.Table_image_url+" VARCHAR);");
