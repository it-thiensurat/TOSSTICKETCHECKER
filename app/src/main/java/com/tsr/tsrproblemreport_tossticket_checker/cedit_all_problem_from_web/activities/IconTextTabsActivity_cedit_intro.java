...
public class IconTextTabsActivity_cedit_intro extends Fragment {
    private int count = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.setAdapter(new CustomFragmentPageAdapterScollview_cedit(getChildFragmentManager()));
