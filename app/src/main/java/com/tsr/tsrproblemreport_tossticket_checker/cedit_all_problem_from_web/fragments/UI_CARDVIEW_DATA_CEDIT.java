...
public class UI_CARDVIEW_DATA_CEDIT extends Fragment implements OnStartDragListener, OnCustomerListChangedListener, View.OnClickListener, ContactAdapter.itemclick, ContactAdapter.itemclick2,OnMapReadyCallback {


    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    @SuppressLint("ValidFragment")
    public UI_CARDVIEW_DATA_CEDIT(Context mContext) {
    ...
    String GET_JSON_DATA_HTTP_URL = BASE_URL+"assanee/checker_system/data_check_new.php";
    String GET_JSON_DATA_HTTP_URL_SE = BASE_URL+"assanee/checker_system/data_check_new_SE.php";
            ...
            try {
                ...
                if(json.getString("Latitude").equals("0.0")){
                   ...
                   // MyApplication.getInstance().getPrefManager().getPreferrence("VersionOS");
                    getDistanceInfo(MyApplication.getInstance().getPrefManager().getPreferrence("latlong"),json.getString("Latitude")+","+json.getString("Longitude"));
