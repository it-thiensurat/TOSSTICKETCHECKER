 ...
 */
public class RecyclerViewAdapter_report_problem_success extends RecyclerView.Adapter<RecyclerViewAdapter_report_problem_success.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapter_report_problem_success(List<GetData_sale> getDataAdapter, Context context){

        super();
        this.getDataAdapter = getDataAdapter;
        this.context = context;
        userFilter = new UserFilter(RecyclerViewAdapter_report_problem_success.this,getDataAdapter);
    }
    ...
    private static class UserFilter extends Filter {
        ...
        private final RecyclerViewAdapter_report_problem_success adapter;

        private final List<GetData_sale> originalList;

        private final List<GetData_sale> filteredList;

        private UserFilter(RecyclerViewAdapter_report_problem_success adapter, List<GetData_sale> originalList) {
            super();
