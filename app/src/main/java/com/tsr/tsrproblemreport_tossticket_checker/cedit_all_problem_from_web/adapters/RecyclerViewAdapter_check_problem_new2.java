 ...
 */
public class RecyclerViewAdapter_check_problem_new2 extends RecyclerView.Adapter<RecyclerViewAdapter_check_problem_new2.ViewHolder> implements Filterable {


    public static Context context;
    List<GetData_check_problem2> getDataAdapter;
    ...
    public RecyclerViewAdapter_check_problem_new2(List<GetData_check_problem2> getDataAdapter, Context context){

        super();
        this.getDataAdapter = getDataAdapter;
        this.context = context;
        userFilter = new UserFilter(RecyclerViewAdapter_check_problem_new2.this,getDataAdapter);
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == layout1) {
            ...
            v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.show_checkbox_cardview_cedit_new_real_1, parent, false);
        }
        else if (viewType == layout2) {
            // self message
            v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.show_checkbox_cardview_cedit_new_real2_2, parent, false);
        }
    ...
    public int getItemViewType(int position) {
        GetData_check_problem2 message = getDataAdapter.get(position);
        try {
    ...
    public void onBindViewHolder(ViewHolder Viewholder, int position) {
        ...
        GetData_check_problem2 getDataAdapter1 =  getDataAdapter.get(position);
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new RecyclerViewAdapter_check_problem_new2.UserFilter(this,getDataAdapter);
        }
    ...
    private RecyclerViewAdapter_check_problem_new2.itemclick_deleteAll ic_deleteAll;
    public void setitemclick_deleteAll(RecyclerViewAdapter_check_problem_new2.itemclick_deleteAll deleteAll){
    ...
    private RecyclerViewAdapter_check_problem_new2.itemclick_image_problem_incorrect ic_image_problem_incorrect;
    public void setitemclick_image_problem_incorrect(RecyclerViewAdapter_check_problem_new2.itemclick_image_problem_incorrect image_problem_incorrect){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener,View.OnClickListener  {
        ...
        public GetData_check_problem2 feed;
    ...
    private static class UserFilter extends Filter {
        ...
        private final RecyclerViewAdapter_check_problem_new2 adapter;

        private final List<GetData_check_problem2> originalList;

        private final List<GetData_check_problem2> filteredList;

        private UserFilter(RecyclerViewAdapter_check_problem_new2 adapter, List<GetData_check_problem2> originalList) {
            super();
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint.length() == 0) {
                ...
                for (final GetData_check_problem2 user : originalList) {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            if (results.count == 0){
                ...
                adapter.getDataAdapter.clear();
                adapter.getDataAdapter.addAll((ArrayList<GetData_check_problem2>) results.values);
                adapter.notifyDataSetChanged();
            }
        }
    }
