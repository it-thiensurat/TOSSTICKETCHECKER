package com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.fragments.line;
...
public class UI_CARDVIEW_DATA_LINE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT extends Fragment implements RecyclerViewDataAdapter.itemclick,RecyclerViewDataAdapter.itemclick2,RecyclerViewDataAdapter.itemclick_list_item_status_sale,RecyclerViewDataAdapter.itemclick_list_item_history  {
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/line/problem_all/line_problem1_json2_real_from_cedit_edit_problem2_copy_real.php";
    String GET_JSON_DATA_HTTP_URL_date1_to_date2 = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/line/problem_all/line_problem1_json2_real_from_cedit_edit_problem2_copy_real_date1_to_date2.php";
...
//            setSupportActionBar(toolbar);
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //Log.e("erere",error.getLocalizedMessage()+"");
    ...
    private void JSON_DATA_WEB_CALLhh() {
        ...
        try {
            ...
            Call call = request.getSale3(user_code);
            Log.e("userCode",user_code + "");
            ...
            /*call.enqueue(new Callback() {
                ...
                public void onResponse(Call call, retrofit2.Response response) {
                    Log.e("onResponse",response.body() + "");
                    Log.e("onResponse",call.request().body() + "");
                    *//*Gson gson=new Gson();
                    try {
