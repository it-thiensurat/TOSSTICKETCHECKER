 ...
 */
public class GetData_cedit implements Parcelable {

    public String Image_ADDRESS;
    public String Image_PAYMENTCARD;
    public String Image_MAPPAYMENT;
    ...
    public String CheckerStatusName;

    public String Fortnight_no;
    public String opendate;
    public String closedate;

    public String ProductSerial;
    public String Outstanding;
    public String PayLastPeriod;

    public String FnYear;
    public String FnMonth;
    public String NoID;
    ...
    public GetData_cedit(Parcel in) {

        Image_ADDRESS=in.readString();
        Image_PAYMENTCARD=in.readString();
        Image_MAPPAYMENT=in.readString();


        Trans_No=in.readString();
        BankName=in.readString();
        BankRef=in.readString();
        BillerNo=in.readString();
        SerialNumber=in.readString();
        Ref2=in.readString();
        QRId=in.readString();
        PayerName=in.readString();
        PayerBank=in.readString();
        ...
        CheckerStatus=in.readString();
        CheckerStatusName=in.readString();

        Fortnight_no=in.readString();
        ...
        PayLastPeriod=in.readString();

        FnYear=in.readString();
        FnMonth=in.readString();
        NoID=in.readString();
       ...
       status_confirm_Image_MAP_old=in.readString();
        ...
        AllPeriods=in.readString();

        AssignDateTime=in.readString();
    }

    public GetData_cedit() {
    ...
    public String getImage_PAYMENTCARD() {
        return Image_PAYMENTCARD;
    }

    public void setImage_PAYMENTCARD(String Image_PAYMENTCARD) {
        this.Image_PAYMENTCARD = Image_PAYMENTCARD;
    }


    public String getImage_MAPPAYMENT() {
        return Image_MAPPAYMENT;
    }

    public void setImage_MAPPAYMENT(String Image_MAPPAYMENT) {
        this.Image_MAPPAYMENT = Image_MAPPAYMENT;
    }
    ...
    public String getFortnight_no() {
        return Fortnight_no;
    }

    public void setFortnight_no(String fortnight_no) {
        Fortnight_no = fortnight_no;
    }
    ...
    public String getFnMonth() {
        return FnMonth;
    }

    public void setFnMonth(String FnMonth) {
        this.FnMonth = FnMonth;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(CheckerStatus);
        parcel.writeString(CheckerStatusName);

        parcel.writeString(ProductSerial);
        parcel.writeString(Outstanding);
        parcel.writeString(PayLastPeriod);

        parcel.writeString(FnYear);
        parcel.writeString(FnMonth);
        ...
        parcel.writeString(PayPeriod);
        parcel.writeString(AllPeriods);

        parcel.writeString(AssignDateTime);
