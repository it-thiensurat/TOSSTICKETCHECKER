...
public class UI_CARDVIEW_DATA_FOR_CHECKER_NO extends Fragment implements OnStartDragListener, OnCustomerListChangedListener, View.OnClickListener, ContactAdapter_sale.itemclick, ContactAdapter_sale.itemclick2,OnMapReadyCallback {


    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    @SuppressLint("ValidFragment")
    public UI_CARDVIEW_DATA_FOR_CHECKER_NO(Context mContext) {
   ...
   // String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/checker_system/sale/data_check_sale2.php";
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/checker_system/sale/data_check_sale3_2.php";
    String GET_JSON_DATA_HTTP_URL_number_page = "http://app.thiensurat.co.th/assanee/checker_system/sale/data_check_sale3_2_number_page.php";
   ...
   public static int position2;
    ...
    public UI_CARDVIEW_DATA_FOR_CHECKER_NO() {
...
//                        pDialog2.dismissWithAnimation();
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array) {
        ...
        contactAdapter = new ContactAdapter_sale(recyclerView, GetDataAdapter1, getActivity(), UI_CARDVIEW_DATA_FOR_CHECKER_NO.this, UI_CARDVIEW_DATA_FOR_CHECKER_NO.this);
        recyclerView.setAdapter(contactAdapter);
