...
public class UI_CARDVIEW_DATA_FOR_CHECKER extends Fragment implements OnStartDragListener, OnCustomerListChangedListener, View.OnClickListener, ContactAdapter_sale.itemclick, ContactAdapter_sale.itemclick2,OnMapReadyCallback {


    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    @SuppressLint("ValidFragment")
    public UI_CARDVIEW_DATA_FOR_CHECKER(Context mContext) {
   ...
   public static int position2;
    ...
    public UI_CARDVIEW_DATA_FOR_CHECKER() {
...
//                        pDialog2.dismissWithAnimation();
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array) {
        ...
        contactAdapter = new ContactAdapter_sale(recyclerView, GetDataAdapter1, getActivity(), UI_CARDVIEW_DATA_FOR_CHECKER.this, UI_CARDVIEW_DATA_FOR_CHECKER.this);
        recyclerView.setAdapter(contactAdapter);
