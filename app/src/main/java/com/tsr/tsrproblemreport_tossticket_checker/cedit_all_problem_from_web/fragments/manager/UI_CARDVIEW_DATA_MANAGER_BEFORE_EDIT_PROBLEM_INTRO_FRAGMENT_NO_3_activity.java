package com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.fragments.manager;
...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.activities.Activity_edit_problem_from_sale_edit_new_uat;
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.activities.Activity_edit_problem_from_sale_uat;
...
import com.tsr.tsrproblemreport_tossticket_checker.test.adapters.RecyclerViewDataAdapter2;
...
public class UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_NO_3_activity extends AppCompatActivity implements RecyclerViewDataAdapter2.itemclick,RecyclerViewDataAdapter2.itemclick2,RecyclerViewDataAdapter2.itemclick_list_item_status_sale,RecyclerViewDataAdapter2.itemclick_list_item_history  {
...
/*
  //  String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/manager/problem_all/manager_problem1_json2_real_from_cedit_edit_problem2_copy_real.php";
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/manager/problem_all/manager_problem1_json2_real_from_cedit_edit_problem2_copy_waiting_to_check_real_no_PAGE_4.php";

    //String GET_JSON_DATA_HTTP_URL_date1_to_date2 = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/manager/problem_all/manager_problem1_json2_real_from_cedit_edit_problem2_copy_real_date1_to_date2.php";
    String GET_JSON_DATA_HTTP_URL_date1_to_date2 = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/manager/problem_all/manager_problem1_json2_real_from_cedit_edit_problem2_copy_waiting_to_check_real_no_PAGE_date1_to_date2_4.php";



    String GET_JSON_DATA_HTTP_URL_number_page = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/manager/problem_all/manager_number_page_no_4.php";
    String GET_JSON_DATA_HTTP_URL_number_page_date1_to_date2 = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/manager/problem_all/manager_number_page_date1_to_date2_no_4.php";
*/
    ...
    RecyclerViewDataAdapter2 recyclerViewDataAdapter;
...
//            setSupportActionBar(toolbar);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                my_recycler_view.setHasFixedSize(true);
                recyclerViewlayoutManager = new LinearLayoutManager(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_NO_3_activity.this);
                my_recycler_view.setLayoutManager(recyclerViewlayoutManager);
                ...
                pDialog2 = new SweetAlertDialog(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_NO_3_activity.this, SweetAlertDialog.PROGRESS_TYPE);
                pDialog2.getProgressHelper().setBarColor(Color.parseColor("#A5DC86"));
                pDialog2.setTitleText("Loading");
                pDialog2.setCancelable(true);
                pDialog2.show();
        ...
        date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePicker = new DatePickerDialog(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_NO_3_activity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        try {
            RecyclerViewDataAdapter2 adapter = new RecyclerViewDataAdapter2(GetDataAdapter1,this, allSampleData,allSampleData2);
            my_recycler_view.setAdapter(adapter);
...
//                recyclerViewDataAdapter.notifyItemRemoved(scrollPosition);
    ...
    public void JSON_DATA_WEB_CALL() {
      ...
      //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
                jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL+"?user_code="+user_code +"&page="+number_page ,
    ...
    public void JSON_DATA_WEB_CALL_date_to_date() {
        ...
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_date1_to_date2+"?user_code="+user_code+"&date1="+date_s+"&date2="+date2_s+"&page="+number_page ,
    ...
    public void JSON_DATA_WEB_CALL_number_page_date1_to_date2() {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_number_page_date1_to_date2+"?user_code="+user_code+"&date1="+date_s+"&date2="+date2_s ,
       ...
       // allSampleData2.clear();
        for (int i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                GetDataAdapter2.setDate_Assing(json.getString("date_create"));
    ...
    public void SELECT_SALE_ALL(String Contno) {
        Log.e("url",API_URL_ALL.GET_JSON_DATA_HTTP_URL43+"?contno="+Contno);

        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL43+"?contno="+Contno ,
    ...
    public void click2(View v, int position) {
        ...
        if(WorkCode.equals("22")){
            ...
            if(ResponStatus.equals("1")){
                Intent Intent = new Intent(this, Activity_edit_problem_from_sale_uat.class);
            ...
            else  if(ResponStatus.equals("0")){
                Intent Intent = new Intent(this, Activity_edit_problem_from_sale_edit_new_uat.class);
                Bundle bun = new Bundle();
                bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
    ...
    String GET_JSON_DATA_HTTP_URL2="http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/manager/problem_all/detalis_all_from_contno_page4.php";
    String conno_aa="";
...
/*
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if(item==0){
                    Intent Intent = new Intent(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_NO_3_activity.this, Show_dails_all.class);
                    Bundle bun = new Bundle();
                    bun.putString("contno", getData_cedit_sale_edit_problem.getContno());
                    Intent.putExtras(bun);
                    startActivityForResult(Intent, 55);
                    ...
                    if(ResponStatus.equals("1")){
                        Intent Intent = new Intent(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_NO_3_activity.this, Activity_edit_problem_from_sale_uat.class);
                        Bundle bun = new Bundle();
                        bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                        bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                        bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
                        ...
                        Intent Intent = new Intent(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_NO_3_activity.this, Activity_edit_problem_from_sale_edit_new_uat.class);
                        Bundle bun = new Bundle();
                        bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                        bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                        bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL3(JSONArray array) {
        ...
        if(array.length()==0){
            new SweetAlertDialog(this, SweetAlertDialog.WARNING_TYPE)
                    ...
                    .setContentText("ไม่พบโครงสร้างของเลขสัญญานี้!")
