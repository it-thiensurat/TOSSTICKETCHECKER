...
List<GetDataAdapterCheckBox_image_id> image_id =new ArrayList<>();
    ...
    public RecyclerViewAdapterCheckBox(List<GetDataAdapterCheckBox> getDataAdapter, Context context, MessageAdapterListener listener, MessageAdapterListener listener2){
    ...
    public void onBindViewHolder(final ViewHolder Viewholder, final int position) {
        ...
        final GetDataAdapterCheckBox getDataAdapter1 =  getDataAdapter.get(position);
        final GetDataAdapterCheckBox getDataAdapter2 =  getDataAdapter.get(position2);

             image_id= getDataAdapter1.getImage();
        //final GetDataAdapterCheckBox_image_id  get_imagee =  image_id.get(position);

                try {
                  //  Log.e("image_s",getDataAdapter1.getImage_error());
                   // Log.e("image_size",getDataAdapter1.getImage_error_size());
                }
                catch (Exception e){
...
/*
        try {
            for (GetDataAdapterCheckBox_image_id s: image_id)
            {
                Log.e("image_s",s.getImage_error());
                Log.e("image_id",s.getImage_error_id());
                Log.e("image_size",s.getImage_error_size());
            }
        }
        catch (Exception e){
        ...
        */
        ...
        Viewholder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(isChecked){
                    ...
                    //status_cick1=true;
                    Viewholder.linear_checkbox.setBackgroundResource(R.drawable.backgroud_report_problem);
                    Viewholder.lbl_problem.setTextColor(0xfff40707);

                            try {
                                if(getDataAdapter1.getImage_error().isEmpty()){

                                    Viewholder.txt_image_error.setBackgroundResource(R.drawable.roun_rect_orange11);

                                }
                                else {
                                    Viewholder.txt_image_error.setBackgroundResource(R.drawable.roun_rect_orange12);
                            ...
                            try {
                                if(getDataAdapter1.getImage_sucess().isEmpty()){


                                    Viewholder.txt_image_sucess.setBackgroundResource(R.drawable.roun_rect_orange11);
                                }
                                else {

                                    Viewholder.txt_image_sucess.setBackgroundResource(R.drawable.roun_rect_orange9);
                   ...
                   // status_cick1=false;
                    Viewholder.linear_checkbox.setBackgroundResource(R.drawable.backgroud_report_problem2);
                    Viewholder.lbl_problem.setTextColor(0xff000000);
                    Viewholder.txt_image_error.setBackgroundResource(R.drawable.roun_rect_orange11);
                    Viewholder.txt_image_sucess.setBackgroundResource(R.drawable.roun_rect_orange11);
                }
        ...
        Viewholder.lbl_problem.setText(getDataAdapter1.getproblem());
        ...
        try {
            Glide.with(context).load(getDataAdapter1.getImage_sucess())
        ...
        try {
            if (getDataAdapter1.getImage_sucess().isEmpty()) {
                ...
                Viewholder.ic_dete2.setVisibility(View.VISIBLE);
            }
        }
...
String size =getDataAdapter1.getImage_error_size();
int sizei= Integer.parseInt(size);
                        if(sizei>1){
                            Viewholder.txt_count_image_error.setText("+"+getDataAdapter1.getImage_error_size()+" ");
        ...
        try {
            ...
            String size =getDataAdapter1.getImage_sucess_size();
            int sizei= Integer.parseInt(size);
            if(sizei>1){
                Viewholder.txt_count_image_success.setText("+"+getDataAdapter1.getImage_sucess_size()+" ");
                Viewholder.txt_count_image_success.setVisibility(View.VISIBLE);
            }
            else {
