...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.activities.UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY_UAT;
...
public class UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_YES2 extends Fragment implements RecyclerViewDataAdapter2.itemclick,RecyclerViewDataAdapter2.itemclick2,RecyclerViewDataAdapter2.itemclick_list_item_status_sale,RecyclerViewDataAdapter2.itemclick_list_item_history  {
...
//                recyclerViewDataAdapter.notifyItemRemoved(scrollPosition);
    ...
    public void JSON_DATA_WEB_CALL() {
      ...
      //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
                jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_YES2+"?user_code="+user_code +"&page="+number_page ,
    ...
    public void JSON_DATA_WEB_CALL_SE(String data) {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_SE_YES3+"?user_code="+user_code +"&data="+data ,
    ...
    public void JSON_DATA_WEB_CALL_date_to_date() {
        ...
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_date1_to_date2_YES2+"?user_code="+user_code+"&date1="+date_s+"&date2="+date2_s+"&page="+number_page ,
    ...
    public void JSON_DATA_WEB_CALL_number_page_date1_to_date2() {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_number_page_date1_to_date2_YES2+"?user_code="+user_code+"&date1="+date_s+"&date2="+date2_s ,
...
*/
    ...
    public void click_list_item_history(View v, int position) {
        getData_cedit_sale_edit_problem = GetDataAdapter1.get(position);
        Intent Intent = new Intent(getActivity(), UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY_UAT.class);
        Bundle bun = new Bundle();
        bun.putString("InformID", getData_cedit_sale_edit_problem.getInformID());
        Intent.putExtras(bun);
