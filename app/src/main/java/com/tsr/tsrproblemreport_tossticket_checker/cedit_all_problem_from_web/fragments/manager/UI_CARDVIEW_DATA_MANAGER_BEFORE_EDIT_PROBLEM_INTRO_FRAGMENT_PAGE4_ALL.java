...
public class UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_PAGE4_ALL extends Fragment implements RecyclerViewDataAdapter2.itemclick,RecyclerViewDataAdapter2.itemclick2,RecyclerViewDataAdapter2.itemclick_list_item_status_sale,RecyclerViewDataAdapter2.itemclick_list_item_history  {
...
//            setSupportActionBar(toolbar);
        ...
        // my_recycler_view.setAdapter(adapter);
            ...
            try {
                RecyclerViewDataAdapter2 adapter = new RecyclerViewDataAdapter2(GetDataAdapter1, getActivity(), allSampleData, allSampleData2);
                my_recycler_view.setAdapter(adapter);
...
//                recyclerViewDataAdapter.notifyItemRemoved(scrollPosition);
    ...
    public void JSON_DATA_WEB_CALL() {
      ...
      //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
                jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_PAGE4_ALL+"?user_code="+user_code +"&page="+number_page ,
    ...
    public void JSON_DATA_WEB_CALL_SE(String data) {
        ...
        String user_code= MyApplication.getInstance().getPrefManager().getPreferrence("EMPID");
        Log.e("uuuu",API_URL_ALL.GET_JSON_DATA_HTTP_URL_SE_PAGE4_ALL+"?user_code="+user_code +"&data="+data );

        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_SE_PAGE4_ALL+"?user_code="+user_code +"&data="+data ,
    ...
    public void JSON_DATA_WEB_CALL_date_to_date() {
        ...
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_date1_to_date2_PAGE4_ALL+"?user_code="+user_code+"&date1="+date_s+"&date2="+date2_s+"&page="+number_page ,
    ...
    public void JSON_DATA_WEB_CALL_number_page() {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_number_page_PAGE4_ALL+"?user_code="+user_code  ,
    ...
    public void JSON_DATA_WEB_CALL_number_page_date1_to_date2() {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_number_page_date1_to_date2_PAGE4_ALL+"?user_code="+user_code+"&date1="+date_s+"&date2="+date2_s ,
    ...
    public void click2(View v, int position) {
        ...
        if(WorkCode.equals("22")){
            ...
            if(ResponStatus.equals("1")){
                Intent Intent = new Intent(getActivity(), Activity_edit_problem_from_sale_uat.class);
                ...
                Intent Intent = new Intent(getActivity(), Activity_edit_problem_from_sale_edit_new_uat.class);
                Bundle bun = new Bundle();
                bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
