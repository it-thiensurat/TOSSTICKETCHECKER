...
public class MainActivity_web_help extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_web_help);
    ...
    private void initWebView() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                 ...
                 * */
                if (Utils_web_help.isSameDomain(postUrl, url)) {
                    Intent intent = new Intent(MainActivity_web_help.this, MainActivity_web_help.class);
    ...
    private void openInAppBrowser(String url) {
        Intent intent = new Intent(MainActivity_web_help.this, BrowserActivity_web_help.class);
