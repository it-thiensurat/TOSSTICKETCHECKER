...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.qrcode.activity.ResultActivity_report_problem;
...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.qrcode.utility.ActivityUtils;
...
public class ScanFragment_report_problem_sale extends Fragment {
    ...
    private void initListener() {
        ...
        zXingScannerView.setResultHandler(new ZXingScannerView.ResultHandler() {
            ...
            public void handleResult(Result result) {
                ...
                ActivityUtils.getInstance().invokeActivity(mActivity, ResultActivity_report_problem.class, false);
                getActivity().finish();
            }
        });
