...
public class UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM extends AppCompatActivity implements RecyclerViewAdapter_sale_recive_problem_before_edit.itemclick2 {
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/sale_problem1_json2_real_from_cedit_edit_problem2_copy_real_contno.php";

    RecyclerViewAdapter_sale_recive_problem_before_edit recyclerViewadapter1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                recyclerViewlayoutManager = new LinearLayoutManager(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM.this);
    ...
    public void JSON_DATA_WEB_CALL() {
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL + "?user_code=" + user_code + "&conno=" + conno,
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array) {
        ...
        recyclerViewadapter1 = new RecyclerViewAdapter_sale_recive_problem_before_edit(GetDataAdapter1, this);
    ...
    public void click2(View v, int position) {
        ...
        if (WorkCode.equals("22")) {
            ...
            if (!open_up_down) {
                ...
                //linear_down.position.setVisibility(View.VISIBLE);
