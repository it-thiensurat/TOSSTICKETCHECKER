...
public class RecyclerViewDataAdapter extends RecyclerView.Adapter<RecyclerViewDataAdapter.ItemRowHolder> {
    ...
    public RecyclerViewDataAdapter(Context context, ArrayList<SectionDataModel> dataList,List<ImageBefore> imageBeforeList) {
    ...
    public void onBindViewHolder(ItemRowHolder itemRowHolder, int i) {
        ...
        SectionListDataAdapter itemListDataAdapter = new SectionListDataAdapter(mContext, singleSectionItems,imageBeforeList);
