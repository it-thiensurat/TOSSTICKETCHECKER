...
public class RecyclerViewDataAdapter4 extends RecyclerView.Adapter<RecyclerViewDataAdapter4.ItemRowHolder> {

    private ArrayList<SectionDataModel2> dataList;
    ArrayList singleSectionItems2;
    SectionListDataAdapter2 itemListDataAdapter;
    private List<ImageAfter> imageAfterList;
    private Context mContext;

    public RecyclerViewDataAdapter4(Context context, ArrayList<SectionDataModel2> dataList,List<ImageAfter> imageAfterList2) {
        this.dataList = dataList;
        this.mContext = context;
        this.imageAfterList=imageAfterList2;
        itemListDataAdapter = new SectionListDataAdapter2(mContext, singleSectionItems2,imageAfterList);
    }
...
//        Log.e("imageAfterListdddd", String.valueOf(imageAfterList.size()));
        if (i == 0) {
            itemRowHolder.itemTitle.setText("ล่าสุด");
        }
        try {
            if(imageAfterList.size()==0){
        ...
        /*
        SectionListDataAdapter2 itemListDataAdapter = new SectionListDataAdapter2(mContext, singleSectionItems);
    ...
    private RecyclerViewDataAdapter4.itemclick_deleteAll ic_deleteAll;
    public void setitemclick_deleteAll(RecyclerViewDataAdapter4.itemclick_deleteAll deleteAll){
