...
public class IconTextTabsActivity_cedit_intro_sale extends Fragment {
    private int count = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.setAdapter(new CustomFragmentPageAdapterScollview_sale(getChildFragmentManager()));
