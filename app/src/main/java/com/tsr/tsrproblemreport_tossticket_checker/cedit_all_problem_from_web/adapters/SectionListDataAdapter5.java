...
public class SectionListDataAdapter5 extends RecyclerView.Adapter<SectionListDataAdapter5.SingleItemRowHolder> {

    private ArrayList<SingleItemModel> itemsList;

    private Context mContext;
    SQLiteDatabase sqLiteDatabase;
    public SectionListDataAdapter5(Context context, ArrayList<SingleItemModel> itemsList) {
