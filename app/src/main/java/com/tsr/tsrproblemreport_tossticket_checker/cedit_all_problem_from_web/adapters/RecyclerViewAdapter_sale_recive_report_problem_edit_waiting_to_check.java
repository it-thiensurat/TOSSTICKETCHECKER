 ...
 */
public class RecyclerViewAdapter_sale_recive_report_problem_edit_waiting_to_check extends RecyclerView.Adapter<RecyclerViewAdapter_sale_recive_report_problem_edit_waiting_to_check.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapter_sale_recive_report_problem_edit_waiting_to_check(List<GetData_cedit_sale_recive_problem> getDataAdapter, Context context){

        super();
        this.getDataAdapter = getDataAdapter;
        this.context = context;
        userFilter = new UserFilter(RecyclerViewAdapter_sale_recive_report_problem_edit_waiting_to_check.this,getDataAdapter);
    }
    ...
    public void onBindViewHolder(ViewHolder Viewholder, int position) {
        ...
        Viewholder.handle2.setBackgroundResource(R.drawable.icon_resume);
    ...
    private static class UserFilter extends Filter {
        ...
        private final RecyclerViewAdapter_sale_recive_report_problem_edit_waiting_to_check adapter;
        ...
        private UserFilter(RecyclerViewAdapter_sale_recive_report_problem_edit_waiting_to_check adapter, List<GetData_cedit_sale_recive_problem> originalList) {
            super();
