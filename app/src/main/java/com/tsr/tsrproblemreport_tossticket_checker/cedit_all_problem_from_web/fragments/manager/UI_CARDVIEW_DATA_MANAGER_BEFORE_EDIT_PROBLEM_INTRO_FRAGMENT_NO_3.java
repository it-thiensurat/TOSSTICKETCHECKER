...
public class UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_NO_3 extends Fragment implements RecyclerViewDataAdapter2.itemclick,RecyclerViewDataAdapter2.itemclick2,RecyclerViewDataAdapter2.itemclick_list_item_status_sale,RecyclerViewDataAdapter2.itemclick_list_item_history  {
...
//                recyclerViewDataAdapter.notifyItemRemoved(scrollPosition);
    ...
    public void JSON_DATA_WEB_CALL_SE(String data) {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_SE_NO3+"?user_code="+user_code +"&data="+data ,
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array) {
        ...
        Log.e("sssss", String.valueOf(array.length()));
