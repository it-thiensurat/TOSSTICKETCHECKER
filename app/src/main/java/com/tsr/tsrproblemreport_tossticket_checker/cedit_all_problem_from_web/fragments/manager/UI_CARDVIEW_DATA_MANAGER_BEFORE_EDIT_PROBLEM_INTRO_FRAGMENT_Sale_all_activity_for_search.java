...
//            setSupportActionBar(toolbar);
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                my_recycler_view.setHasFixedSize(true);
                recyclerViewlayoutManager = new LinearLayoutManager(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_Sale_all_activity_for_search.this);
                my_recycler_view.setLayoutManager(recyclerViewlayoutManager);
                ...
                pDialog2 = new SweetAlertDialog(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_Sale_all_activity_for_search.this, SweetAlertDialog.PROGRESS_TYPE);
                pDialog2.getProgressHelper().setBarColor(Color.parseColor("#A5DC86"));
                pDialog2.setTitleText("Loading");
                pDialog2.setCancelable(true);
                pDialog2.show();
        ...
        date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePicker = new DatePickerDialog(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_Sale_all_activity_for_search.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
     ...
     /*   getData_cedit_sale_edit_problem = GetDataAdapter1.get(position);
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if(item==0){
                    Intent Intent = new Intent(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_Sale_all_activity_for_search.this, Show_dails_all.class);
                    Bundle bun = new Bundle();
                    bun.putString("contno", getData_cedit_sale_edit_problem.getContno());
                    Intent.putExtras(bun);
                    startActivityForResult(Intent, 55);
                    ...
                    if(ResponStatus.equals("1")){
                        Intent Intent = new Intent(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_Sale_all_activity_for_search.this, Activity_edit_problem_from_sale_uat.class);
                        Bundle bun = new Bundle();
                        bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                        bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                        bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
                        ...
                        Intent Intent = new Intent(UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_Sale_all_activity_for_search.this, Activity_edit_problem_from_sale_edit_new_uat.class);
                        Bundle bun = new Bundle();
                        bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                        bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                        bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
