...
public class SQLiteHelper_position_delate_image extends SQLiteOpenHelper {

    public static String DATABASE_NAME="TV_DELATE";
    public static final String TABLE_NAME="position_delate_image";
    public static final String Table_Column_ID="id";


    public static final String Table_position="position";
    public static final String Table_image_url="image_url";



    public SQLiteHelper_position_delate_image(Context context) {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        String CREATE_TABLE="CREATE TABLE IF NOT EXISTS "+TABLE_NAME+" ("+Table_Column_ID+" INTEGER PRIMARY KEY,  "+Table_position+" VARCHAR,  "+Table_image_url+" VARCHAR)";
