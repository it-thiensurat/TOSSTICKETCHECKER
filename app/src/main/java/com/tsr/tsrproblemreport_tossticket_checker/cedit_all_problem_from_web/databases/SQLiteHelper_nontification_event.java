...
public class SQLiteHelper_nontification_event extends SQLiteOpenHelper {

    public static String DATABASE_NAME="TV_ONLINE";
    public static final String TABLE_NAME="nontification_event";
    ...
    public SQLiteHelper_nontification_event(Context context) {
