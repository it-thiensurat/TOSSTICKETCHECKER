...
public class UI_CARDVIEW_DATA_MANAGER_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_NO_1 extends Fragment implements RecyclerViewDataAdapter.itemclick,RecyclerViewDataAdapter.itemclick2,RecyclerViewDataAdapter.itemclick_list_item_status_sale,RecyclerViewDataAdapter.itemclick_list_item_history  {
...
//                recyclerViewDataAdapter.notifyItemRemoved(scrollPosition);
    ...
    public void JSON_DATA_WEB_CALL() {
      ...
      //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
                jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_1+"?user_code="+user_code +"&page="+number_page ,
    ...
    public void JSON_DATA_WEB_CALL_SE(String data) {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_SE_NO1+"?user_code="+user_code +"&data="+data ,
    ...
    public void JSON_DATA_WEB_CALL_date_to_date() {
        ...
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_date1_to_date2_1+"?user_code="+user_code+"&date1="+date_s+"&date2="+date2_s+"&page="+number_page ,
    ...
    public void JSON_DATA_WEB_CALL_number_page() {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_number_page_1+"?user_code="+user_code  ,
    ...
    public void JSON_DATA_WEB_CALL_number_page_date1_to_date2() {
        ...
        //  jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code ,
        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL_number_page_date1_to_date2_1+"?user_code="+user_code+"&date1="+date_s+"&date2="+date2_s ,
    ...
    public void SELECT_SALE_ALL(String Contno) {
        Log.e("url",API_URL_ALL.GET_JSON_DATA_HTTP_URL43_1+"?contno="+Contno);

        jsonArrayRequest = new JsonArrayRequest(API_URL_ALL.GET_JSON_DATA_HTTP_URL43_1+"?contno="+Contno ,
