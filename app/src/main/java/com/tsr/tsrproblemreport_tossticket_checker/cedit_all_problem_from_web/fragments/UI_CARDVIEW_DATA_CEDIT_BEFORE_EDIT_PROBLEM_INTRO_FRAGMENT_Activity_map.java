...
public class UI_CARDVIEW_DATA_CEDIT_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_Activity_map extends AppCompatActivity implements RecyclerViewAdapter_cedit_sent_problem_before_edit.itemclick2  {
...
//    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/sale_problem1_json2_real_from_cedit_edit_problem2.php";
    ...
    public void JSON_DATA_WEB_CALL() {
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code+"&Contno="+conno ,
