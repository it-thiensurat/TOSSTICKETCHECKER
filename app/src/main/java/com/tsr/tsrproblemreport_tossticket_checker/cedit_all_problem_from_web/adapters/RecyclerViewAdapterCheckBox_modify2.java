 ...
 */
public class RecyclerViewAdapterCheckBox_modify2 extends RecyclerView.Adapter<RecyclerViewAdapterCheckBox_modify2.ViewHolder> {

    Context context;

    List<GetDataAdapterCheckBox_modify> getDataAdapter;
    ...
    public RecyclerViewAdapterCheckBox_modify2(List<GetDataAdapterCheckBox_modify> getDataAdapter, Context context){
    ...
    public void onBindViewHolder(final ViewHolder Viewholder, int position) {
        ...
        GetDataAdapterCheckBox_modify getDataAdapter1 =  getDataAdapter.get(position);
...
*/
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ImageView image_problem_incorrect,image_problem_sucess;
        //  public ImageView networkImageView ;



        public GetDataAdapterCheckBox_modify feed;
