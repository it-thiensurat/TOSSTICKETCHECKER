...
public class SectionListDataAdapter8 extends RecyclerView.Adapter<SectionListDataAdapter8.SingleItemRowHolder> {

    private ArrayList<SingleItemModel2> itemsList;
    private List<ImageAfter> imageAfterList = new ArrayList<>();
    private Context mContext;
    int ii;
    public SectionListDataAdapter8(Context context, ArrayList<SingleItemModel2> itemsList, List<ImageAfter> imageAfterList, int position) {
    ...
    public void onBindViewHolder(SingleItemRowHolder holder, final int i) {
        ...
        Log.e("position_imageB", String.valueOf(i));
