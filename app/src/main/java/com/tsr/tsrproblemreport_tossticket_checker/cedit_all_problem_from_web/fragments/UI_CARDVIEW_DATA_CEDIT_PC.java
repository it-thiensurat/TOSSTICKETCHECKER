...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.activities.Detali_data_cedit3;
...
public class UI_CARDVIEW_DATA_CEDIT_PC extends Fragment implements OnStartDragListener, OnCustomerListChangedListener, View.OnClickListener, ContactAdapter.itemclick, ContactAdapter.itemclick2,OnMapReadyCallback {


    private Context mContext;
    GetData_cedit_map getData_cedit_map;
    @SuppressLint("ValidFragment")
    public UI_CARDVIEW_DATA_CEDIT_PC(Context mContext) {
    ...
    String GET_JSON_DATA_HTTP_URL = BASE_URL+"assanee/checker_system/data_check_new_pc.php";
    String GET_JSON_DATA_HTTP_URL_SE = BASE_URL+"assanee/checker_system/data_check_new_SE_pc.php";
   ...
   public static int position2;
    ...
    Thread thread;
    public UI_CARDVIEW_DATA_CEDIT_PC() {
...
/*        if (musicActivity_credit.dad == 1) {
        ...
        if (musicActivity_credit.dad == 2) {
           ...
           if(dad==1){
               ...
               pDialog2.setTitleText("กำลังอัฟเดทระยะทาง...");
               ...
               try {
                   if(MyApplication.getInstance().getPrefManager().getPreferrence("intro_save_pc").equals("1")){
                    //   GetDataAdapter1.clear();
                     //  JSON_DATA_WEB_CALL2();
                       SQLiteDataBaseBuild_data_checker_all();
                       SQLiteTableBuild_data_checker_all();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MyApplication.getInstance().getPrefManager().setPreferrence("dat2_pc", "0");
      ...
      //  SQLiteTableBuild_data_checker_all();
        ...
        for (i = 0; i < array.length(); i++) {
            ...
            try {
                ...
                GetDataAdapter2.setNoID(json.getString("NoID"));
                ...
                GetDataAdapter2.setAssignDateTime(json.getString("AssignDateTime"));
        ...
        try {
            ...
            String dat2 = MyApplication.getInstance().getPrefManager().getPreferrence("dat2_pc");

            if ((dat2.equals("0")) | (dat2.equals("null"))) {

                contactAdapter = new ContactAdapter(recyclerView, GetDataAdapter1, getActivity(), UI_CARDVIEW_DATA_CEDIT_PC.this, UI_CARDVIEW_DATA_CEDIT_PC.this);
                ...
                mShimmerViewContainer.setVisibility(View.GONE);
                    ...
                    if (iis == ContactAdapter.position_adap) {
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL2(JSONArray array) {
       ...
       SQLiteDataBaseBuild_data_checker_all();
        ...
        GetDataAdapter1.clear();
        cursor = sqLiteDatabase.rawQuery("SELECT CONTNO,RefNo,SaleEmployeeName,SaleTeamCode,SaleHeaderName,IDCARD,CustomerName,ADDRESSS,Tel,ProductName,EFFDATE,Dis,Latitude,Longitude,Outstanding,PayLastPeriod,FnYear,FnMonth,ProductSerial,NoID,CheckerStatus,CheckerStatusName,Fortnight_no,opendate,closedate,AssignDateTime FROM "+SQLiteHelper_data_checker_all.TABLE_NAME+""  +" order  by Dis ASC"   , null);
        if (cursor.moveToFirst()) {
            do {
                ...
                String Table_ProductSerial = cursor.getString(cursor.getColumnIndex(SQLiteHelper_data_checker_all.Table_ProductSerial));
                String Table_NoID = cursor.getString(cursor.getColumnIndex(SQLiteHelper_data_checker_all.Table_NoID));
                Log.e("Table_Dis", Table_Dis);


                String Table_CheckerStatus = cursor.getString(cursor.getColumnIndex(SQLiteHelper_data_checker_all.Table_CheckerStatus));
                String Table_CheckerStatusName = cursor.getString(cursor.getColumnIndex(SQLiteHelper_data_checker_all.Table_CheckerStatusName));

                String Table_Fortnight_no = cursor.getString(cursor.getColumnIndex(SQLiteHelper_data_checker_all.Table_Fortnight_no));
                String Table_opendate = cursor.getString(cursor.getColumnIndex(SQLiteHelper_data_checker_all.Table_opendate));
                String Table_closedate = cursor.getString(cursor.getColumnIndex(SQLiteHelper_data_checker_all.Table_closedate));

                String Table_AssignDateTime = cursor.getString(cursor.getColumnIndex(SQLiteHelper_data_checker_all.Table_AssignDateTime));
                ...
                if(Double.parseDouble(Table_Dis)<=99){
                    ...
                    GetDataAdapter2.setProductSerial(Table_ProductSerial);
                    GetDataAdapter2.setNoID(Table_NoID);


                    GetDataAdapter2.setCheckerStatus(Table_CheckerStatus);
                    GetDataAdapter2.setCheckerStatusName(Table_CheckerStatusName);

                    GetDataAdapter2.setFortnight_no(Table_Fortnight_no);
                    GetDataAdapter2.setOpendate(Table_opendate);
                    GetDataAdapter2.setClosedate(Table_closedate);

                    GetDataAdapter2.setAssignDateTime(Table_AssignDateTime);
            ...
            try {
                ...
                if(json.getString("Latitude").equals("0.0")){
                    ...
                    GetDataAdapter2.setdis("10000");
                        ...
                        String SQLiteDataBaseQueryHolder = "INSERT INTO " + SQLiteHelper_data_checker_all.TABLE_NAME + " (CONTNO,RefNo,SaleEmployeeName,SaleTeamCode,SaleHeaderName,IDCARD,CustomerName,ADDRESSS,Tel,Tel2,ProductName,EFFDATE,Dis,Latitude,Longitude,Outstanding,PayLastPeriod,FnYear,FnMonth,ProductSerial,NoID,CheckerStatus,CheckerStatusName,Fortnight_no,opendate,closedate,AssignDateTime) VALUES('" + json.getString("Contno") + "','" + "1234" + "','" + json.getString("SaleEmployeeName") + "','" + json.getString("SaleCode") + "','" + "assanee" + "','" + json.getString("IDCard") + "','" + json.getString("CustomerName") + "','" + json.getString("Addressall")+ "','" + json.getString("TelHome")+ "','" + json.getString("TelMobile")+ "','" + json.getString("ProductName")+ "','" + json.getJSONObject("EffDate").getString("date")+ "','" + 10000.00+ "','" + json.getString("Latitude")+ "','" + json.getString("Longitude")+ "','" + json.getString("Outstanding")+ "','" + json.getString("PayLastPeriod")+ "','" + json.getString("FnYear")+ "','" + json.getString("FnMonth")+ "','" + json.getString("ProductSerial") + "','" + json.getString("NoID")+ "','" + json.getString("CheckerStatus")+ "','" + json.getString("CheckerStatusName")+ "','" + json.getString("Fortnight_no")+ "','" + json.getString("opendate")+ "','" + json.getString("closedate")+ "','" + json.getString("AssignDateTime") + "');";
                   ...
                   // MyApplication.getInstance().getPrefManager().getPreferrence("VersionOS");
                    getDistanceInfo(MyApplication.getInstance().getPrefManager().getPreferrence("latlong_pc"),json.getString("Latitude")+","+json.getString("Longitude"));
...
*/
        ...
        MyApplication.getInstance().getPrefManager().setPreferrence("intro_save_pc", "1");
...
/*            if (musicActivity_credit.dad == 1) {
   ...
   //     MenuItem menuItemุ7 = menu.findItem(R.id.map_contno);
    ...
    public void click2(View v, int position) {
        try {
            ...
            if(getData_cedit.getCheckerStatus().equals("99")){
                ...
                Intent Intent = new Intent(getActivity(), Detali_data_cedit3.class);


                Bundle bun = new Bundle();
                //    bun.putString("from","by_cedit");
                bun.putString("NoID", getData_cedit.getNoID());
                bun.putString("ProductSerial", getData_cedit.getProductSerial());
    ...
    public void onNoteListChanged(List<GetData_cedit> jobItemList) {
        ...
        MyApplication.getInstance().getPrefManager().setPreferrence("key_sort_pc", jsonListOfSortedCustomerIds);
    ...
    public void onClick(View view) {
        if (view == fab) {
            MyApplication.getInstance().getPrefManager().setPreferrence("dat2_pc", "1");
...
/*ffff
    ...
    private List<GetData_cedit> getOrderItem(List<GetData_cedit> jobItemList) {
        ...
        try {
            String jsonListOfSortedJobItem = MyApplication.getInstance().getPrefManager().getPreferrence("key_sort_pc");
    ...
    private double getDistanceInfo(String city1 ,String city2) {
        ...
        try {
          ...
          //  String  url = "https://maps.googleapis.com/maps/api/distancematrix/json?origins=Seattle&destinations=San+Francisco&key=AIzaSyDau8gZ_HY0WVrGMWVLe7ciYIGeRWklE84";
            String  url = "https://maps.googleapis.com/maps/api/distancematrix/json?origins="+URLEncoder.encode(city1, "UTF-8")+"&destinations="+URLEncoder.encode(city2, "UTF-8")+"&key=AIzaSyBR-3_XnH7XjAc7LxVKBFV2C40rLNBLJYc";
