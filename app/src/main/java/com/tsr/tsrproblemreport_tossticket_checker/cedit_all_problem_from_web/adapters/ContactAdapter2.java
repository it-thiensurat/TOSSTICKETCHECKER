...
public class ContactAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable, ItemTouchHelperAdapter {
...
Dialog dialog3;
   ...
   // String GET_JSON_DATA_HTTP_URL_insent_map = "http://app.thiensurat.co.th/assanee/api_cedit_all_problem_from_web/insertdismap.php";
    ...
    public ContactAdapter2(RecyclerView recyclerView, List<GetData_cedit> contacts, FragmentActivity context, OnStartDragListener dragStartListener, OnCustomerListChangedListener onCustomerListChangedListener){
        super();
       ...
       // this.activity = activity;
        ...
        userFilter = new UserFilter(ContactAdapter2.this,contacts);
...
public void Setloc(String a,String b){
    ...
    public Filter getFilter() {
        if(userFilter!=null){
            userFilter=new ContactAdapter2.UserFilter(this,contacts);
        }
    ...
    private ContactAdapter2.itemclick ic;
    public void setitemclick(ContactAdapter2.itemclick ic){
        this.ic=ic;
    }
    ...
    private ContactAdapter2.itemclick2 ic2;
    public void setitemclick2(ContactAdapter2.itemclick2 ic2){
        this.ic2=ic2;
    }
    ...
    private static class UserFilter extends Filter {
        ...
        private final ContactAdapter2 adapter;

        private final List<GetData_cedit> originalList;

        private final List<GetData_cedit> filteredList;

        private UserFilter(ContactAdapter2 adapter, List<GetData_cedit> originalList) {
            super();
