...
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.adapters.manager.RecyclerViewAdapter_manager_recive_problem_before_edit_acty;
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.databases.SQLiteHelper;
import com.tsr.tsrproblemreport_tossticket_checker.cedit_all_problem_from_web.fragments.MainActivity;
...
public class UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY_UAT extends AppCompatActivity implements RecyclerViewAdapter_manager_recive_problem_before_edit_acty.itemclick,RecyclerViewAdapter_manager_recive_problem_before_edit_acty.itemclick2,RecyclerViewAdapter_manager_recive_problem_before_edit_acty.itemclick_list_item_status_sale,RecyclerViewAdapter_manager_recive_problem_before_edit_acty.itemclick_txt_comment {
...
/*
    ...
    String GET_JSON_DATA_HTTP_URL_date1_to_date2 = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/sale_problem1_json2_real_from_cedit_edit_problem2_copy_real_date1_to_date2.php";
...
//UAT
    ...
    String GET_JSON_DATA_HTTP_URL = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/sale_problem1_json2_real_from_cedit_edit_problem2_copy_real_history_number_uat.php";
    String GET_JSON_DATA_HTTP_URL_date1_to_date2 = "http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/sale/problem_all/sale_problem1_json2_real_from_cedit_edit_problem2_copy_real_date1_to_date2_UAT.php";
    String GET_JSON_DATA_HTTP_URL43="http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/manager/problem_all/avc4_UAT.php";
    String GET_JSON_DATA_HTTP_URL2="http://app.thiensurat.co.th/assanee/api_sale_all_problem_from_cedit_by_db_kiw/manager/problem_all/detalis_all_from_contno_UAT.php";





    RecyclerViewAdapter_manager_recive_problem_before_edit_acty recyclerViewadapter1;
    ...
    RelativeLayout relativeLayout,relativeLayout_date;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePicker = new DatePickerDialog(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY_UAT.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
...
Log.e("InformID_acty",InformID);
        }
        Log.e("NOW_MANAGER","NOW_MANAGER");
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                recyclerViewlayoutManager = new LinearLayoutManager(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY_UAT.this);
                ...
                pDialog2 = new SweetAlertDialog(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY_UAT.this, SweetAlertDialog.PROGRESS_TYPE);
                pDialog2.getProgressHelper().setBarColor(Color.parseColor("#A5DC86"));
                pDialog2.setTitleText("Loading");
                pDialog2.setCancelable(true);
                pDialog2.show();
    ...
    public void JSON_DATA_WEB_CALL() {
        ...
        jsonArrayRequest = new JsonArrayRequest(GET_JSON_DATA_HTTP_URL+"?user_code="+user_code+"&InformID="+InformID ,
    ...
    public void JSON_PARSE_DATA_AFTER_WEBCALL(JSONArray array) {
        ...
        recyclerViewadapter1 = new RecyclerViewAdapter_manager_recive_problem_before_edit_acty(GetDataAdapter1,this);
        ...
        recyclerViewadapter1.setitemclick_txt_comment(this);
    }
   ...
   public static boolean open_up_down=false;
    ...
    public void click2(View v, int position) {
        ...
        if(WorkCode.equals("222")){


            if(ResponStatus.equals("1")){
                Intent Intent = new Intent(this, Activity_edit_problem_from_sale.class);
                ...
                Intent Intent = new Intent(this, Activity_edit_problem_from_sale_edit_new.class);
                Bundle bun = new Bundle();
                bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
    ...
    public void click(View v, int position) {
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if(item==0){
                    Intent Intent = new Intent(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY_UAT.this, Show_dails_all.class);
                    Bundle bun = new Bundle();
                    bun.putString("contno", getData_cedit_sale_edit_problem.getContno());
                    Intent.putExtras(bun);
                    startActivityForResult(Intent, 55);
                    ...
                    String ResponStatus=getData_cedit_sale_edit_problem.getResponStatus();
                        ...
                        if(ResponStatus.equals("1")){
                            Intent Intent = new Intent(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY_UAT.this, Activity_edit_problem_from_sale.class);
                            Bundle bun = new Bundle();
                            bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                            bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                            bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
                            ...
                            Intent Intent = new Intent(UI_CARDVIEW_DATA_SALE_BEFORE_EDIT_PROBLEM_INTRO_FRAGMENT_ACTIVITY_UAT.this, Activity_edit_problem_from_sale_edit_new.class);
                            Bundle bun = new Bundle();
                            bun.putString("ID", getData_cedit_sale_edit_problem.getID());
                            bun.putString("Gory", getData_cedit_sale_edit_problem.getGory());
                            bun.putString("Main", getData_cedit_sale_edit_problem.getMain());
    ...
    @Override
    public void click_txt_comment(View v, int position) {
